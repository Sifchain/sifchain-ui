import { computed, defineComponent, PropType, ComputedRef, ref } from "vue";
import clsx from "clsx";
import { useRouter } from "vue-router";
import { Asset, IAsset, Network } from "@sifchain/sdk";
...
export const RiskWarning = defineComponent({
...
export const AssetPair = defineComponent({
  name: "AssetPair",
  props: {
    hideTokenSymbol: {
