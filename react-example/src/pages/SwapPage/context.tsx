...
const useSwapPageData = () => {
  ...
  const [swapQuote, setSwapQuote] = useState<ReturnType<
    typeof sdk.liquidity.swap.createSwapQuote
  > | null>(null);
...
export const SwapPageProvider = (props: { children: any }) => {
  ...
  return (
    <SwapContext.Provider value={data}>{props.children}</SwapContext.Provider>
  );
};
