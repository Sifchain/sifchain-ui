...
export function CosmosStakingV1beta1QueryRedelegationsResponseFromJSON(json: any): CosmosStakingV1beta1QueryRedelegationsResponse {
    return CosmosStakingV1beta1QueryRedelegationsResponseFromJSONTyped(json, false);
}

export function CosmosStakingV1beta1QueryRedelegationsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CosmosStakingV1beta1QueryRedelegationsResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'redelegationResponses': !exists(json, 'redelegation_responses') ? undefined : ((json['redelegation_responses'] as Array<any>).map(InlineResponse20028RedelegationResponsesFromJSON)),
        'pagination': !exists(json, 'pagination') ? undefined : InlineResponse2002PaginationFromJSON(json['pagination']),
    };
}

export function CosmosStakingV1beta1QueryRedelegationsResponseToJSON(value?: CosmosStakingV1beta1QueryRedelegationsResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'redelegation_responses': value.redelegationResponses === undefined ? undefined : ((value.redelegationResponses as Array<any>).map(InlineResponse20028RedelegationResponsesToJSON)),
