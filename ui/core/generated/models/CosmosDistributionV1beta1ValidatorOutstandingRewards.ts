...
export function CosmosDistributionV1beta1ValidatorOutstandingRewardsFromJSON(json: any): CosmosDistributionV1beta1ValidatorOutstandingRewards {
    return CosmosDistributionV1beta1ValidatorOutstandingRewardsFromJSONTyped(json, false);
}

export function CosmosDistributionV1beta1ValidatorOutstandingRewardsFromJSONTyped(json: any, ignoreDiscriminator: boolean): CosmosDistributionV1beta1ValidatorOutstandingRewards {
...
export function CosmosDistributionV1beta1ValidatorOutstandingRewardsToJSON(value?: CosmosDistributionV1beta1ValidatorOutstandingRewards | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
