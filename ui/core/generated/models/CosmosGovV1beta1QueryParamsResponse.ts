...
export function CosmosGovV1beta1QueryParamsResponseFromJSON(json: any): CosmosGovV1beta1QueryParamsResponse {
    return CosmosGovV1beta1QueryParamsResponseFromJSONTyped(json, false);
}

export function CosmosGovV1beta1QueryParamsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CosmosGovV1beta1QueryParamsResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'votingParams': !exists(json, 'voting_params') ? undefined : InlineResponse20018VotingParamsFromJSON(json['voting_params']),
        'depositParams': !exists(json, 'deposit_params') ? undefined : InlineResponse20018DepositParamsFromJSON(json['deposit_params']),
        'tallyParams': !exists(json, 'tally_params') ? undefined : InlineResponse20018TallyParamsFromJSON(json['tally_params']),
    };
}

export function CosmosGovV1beta1QueryParamsResponseToJSON(value?: CosmosGovV1beta1QueryParamsResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
