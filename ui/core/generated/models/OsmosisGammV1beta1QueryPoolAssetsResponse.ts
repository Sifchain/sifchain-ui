...
export function OsmosisGammV1beta1QueryPoolAssetsResponseFromJSON(json: any): OsmosisGammV1beta1QueryPoolAssetsResponse {
    return OsmosisGammV1beta1QueryPoolAssetsResponseFromJSONTyped(json, false);
}

export function OsmosisGammV1beta1QueryPoolAssetsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): OsmosisGammV1beta1QueryPoolAssetsResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'poolAssets': !exists(json, 'poolAssets') ? undefined : ((json['poolAssets'] as Array<any>).map()),
    };
}

export function OsmosisGammV1beta1QueryPoolAssetsResponseToJSON(value?: OsmosisGammV1beta1QueryPoolAssetsResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'poolAssets': value.poolAssets === undefined ? undefined : ((value.poolAssets as Array<any>).map()),
    };
}
