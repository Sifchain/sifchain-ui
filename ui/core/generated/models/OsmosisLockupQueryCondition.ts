...
export function OsmosisLockupQueryConditionFromJSON(json: any): OsmosisLockupQueryCondition {
    return OsmosisLockupQueryConditionFromJSONTyped(json, false);
}

export function OsmosisLockupQueryConditionFromJSONTyped(json: any, ignoreDiscriminator: boolean): OsmosisLockupQueryCondition {
...
export function OsmosisLockupQueryConditionToJSON(value?: OsmosisLockupQueryCondition | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
