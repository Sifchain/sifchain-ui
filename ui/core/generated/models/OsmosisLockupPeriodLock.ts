...
export function OsmosisLockupPeriodLockFromJSON(json: any): OsmosisLockupPeriodLock {
    return OsmosisLockupPeriodLockFromJSONTyped(json, false);
}

export function OsmosisLockupPeriodLockFromJSONTyped(json: any, ignoreDiscriminator: boolean): OsmosisLockupPeriodLock {
...
export function OsmosisLockupPeriodLockToJSON(value?: OsmosisLockupPeriodLock | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
