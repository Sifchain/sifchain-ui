 ...
 * @export
 * @interface OsmosisGammV1beta1PoolParams
 */
export interface OsmosisGammV1beta1PoolParams {
    /**
     * 
     * @type {string}
     * @memberof OsmosisGammV1beta1PoolParams
     */
    swapFee?: string;
    /**
     * 
...
export function OsmosisGammV1beta1PoolParamsFromJSON(json: any): OsmosisGammV1beta1PoolParams {
    return OsmosisGammV1beta1PoolParamsFromJSONTyped(json, false);
}

export function OsmosisGammV1beta1PoolParamsFromJSONTyped(json: any, ignoreDiscriminator: boolean): OsmosisGammV1beta1PoolParams {
...
export function OsmosisGammV1beta1PoolParamsToJSON(value?: OsmosisGammV1beta1PoolParams | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
