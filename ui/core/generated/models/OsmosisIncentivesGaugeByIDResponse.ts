...
export function OsmosisIncentivesGaugeByIDResponseFromJSON(json: any): OsmosisIncentivesGaugeByIDResponse {
    return OsmosisIncentivesGaugeByIDResponseFromJSONTyped(json, false);
}

export function OsmosisIncentivesGaugeByIDResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): OsmosisIncentivesGaugeByIDResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'gauge': !exists(json, 'gauge') ? undefined : OsmosisIncentivesActiveGaugesResponseDataFromJSON(json['gauge']),
    };
}

export function OsmosisIncentivesGaugeByIDResponseToJSON(value?: OsmosisIncentivesGaugeByIDResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
