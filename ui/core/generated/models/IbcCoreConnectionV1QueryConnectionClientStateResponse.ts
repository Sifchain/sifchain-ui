...
export function IbcCoreConnectionV1QueryConnectionClientStateResponseFromJSON(json: any): IbcCoreConnectionV1QueryConnectionClientStateResponse {
    return IbcCoreConnectionV1QueryConnectionClientStateResponseFromJSONTyped(json, false);
}

export function IbcCoreConnectionV1QueryConnectionClientStateResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): IbcCoreConnectionV1QueryConnectionClientStateResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'identifiedClientState': !exists(json, 'identified_client_state') ? undefined : ClientStateAssociatedWithTheChannelFromJSON(json['identified_client_state']),
...
export function IbcCoreConnectionV1QueryConnectionClientStateResponseToJSON(value?: IbcCoreConnectionV1QueryConnectionClientStateResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'identified_client_state': ClientStateAssociatedWithTheChannelToJSON(value.identifiedClientState),
        'proof': value.proof,
