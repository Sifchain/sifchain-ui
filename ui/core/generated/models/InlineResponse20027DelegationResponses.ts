...
export function InlineResponse20027DelegationResponsesFromJSON(json: any): InlineResponse20027DelegationResponses {
    return InlineResponse20027DelegationResponsesFromJSONTyped(json, false);
}

export function InlineResponse20027DelegationResponsesFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse20027DelegationResponses {
...
export function InlineResponse20027DelegationResponsesToJSON(value?: InlineResponse20027DelegationResponses | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
