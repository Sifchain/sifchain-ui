...
export function InlineResponse20019ProposalsFromJSON(json: any): InlineResponse20019Proposals {
    return InlineResponse20019ProposalsFromJSONTyped(json, false);
}

export function InlineResponse20019ProposalsFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse20019Proposals {
...
export function InlineResponse20019ProposalsToJSON(value?: InlineResponse20019Proposals | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
