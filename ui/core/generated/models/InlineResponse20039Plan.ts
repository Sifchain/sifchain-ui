...
export function InlineResponse20039PlanFromJSON(json: any): InlineResponse20039Plan {
    return InlineResponse20039PlanFromJSONTyped(json, false);
}

export function InlineResponse20039PlanFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse20039Plan {
...
export function InlineResponse20039PlanToJSON(value?: InlineResponse20039Plan | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
