...
export function HeightAtWhichTheProofWasGeneratedFromJSON(json: any): HeightAtWhichTheProofWasGenerated {
    return HeightAtWhichTheProofWasGeneratedFromJSONTyped(json, false);
}

export function HeightAtWhichTheProofWasGeneratedFromJSONTyped(json: any, ignoreDiscriminator: boolean): HeightAtWhichTheProofWasGenerated {
    ...
    return {
        ...
        'revisionHeight': !exists(json, 'revision_height') ? undefined : json['revision_height'],
    };
}

export function HeightAtWhichTheProofWasGeneratedToJSON(value?: HeightAtWhichTheProofWasGenerated | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
