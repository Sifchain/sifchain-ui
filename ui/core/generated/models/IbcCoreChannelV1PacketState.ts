...
export function IbcCoreChannelV1PacketStateFromJSON(json: any): IbcCoreChannelV1PacketState {
    return IbcCoreChannelV1PacketStateFromJSONTyped(json, false);
}

export function IbcCoreChannelV1PacketStateFromJSONTyped(json: any, ignoreDiscriminator: boolean): IbcCoreChannelV1PacketState {
...
export function IbcCoreChannelV1PacketStateToJSON(value?: IbcCoreChannelV1PacketState | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
