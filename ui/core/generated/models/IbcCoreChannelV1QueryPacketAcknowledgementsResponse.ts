...
export function IbcCoreChannelV1QueryPacketAcknowledgementsResponseFromJSON(json: any): IbcCoreChannelV1QueryPacketAcknowledgementsResponse {
    return IbcCoreChannelV1QueryPacketAcknowledgementsResponseFromJSONTyped(json, false);
}

export function IbcCoreChannelV1QueryPacketAcknowledgementsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): IbcCoreChannelV1QueryPacketAcknowledgementsResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'acknowledgements': !exists(json, 'acknowledgements') ? undefined : ((json['acknowledgements'] as Array<any>).map(QueryPacketAcknowledgemetsResponseIsTheRequestTypeForTheQueryQueryPacketAcknowledgementsRPCMethodAcknowledgementsFromJSON)),
...
export function IbcCoreChannelV1QueryPacketAcknowledgementsResponseToJSON(value?: IbcCoreChannelV1QueryPacketAcknowledgementsResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'acknowledgements': value.acknowledgements === undefined ? undefined : ((value.acknowledgements as Array<any>).map(QueryPacketAcknowledgemetsResponseIsTheRequestTypeForTheQueryQueryPacketAcknowledgementsRPCMethodAcknowledgementsToJSON)),
