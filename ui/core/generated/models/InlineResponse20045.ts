...
export function InlineResponse20045FromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse20045 {
...
export function InlineResponse20045ToJSON(value?: InlineResponse20045 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
