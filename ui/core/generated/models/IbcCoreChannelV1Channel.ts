...
export function IbcCoreChannelV1ChannelFromJSON(json: any): IbcCoreChannelV1Channel {
    return IbcCoreChannelV1ChannelFromJSONTyped(json, false);
}

export function IbcCoreChannelV1ChannelFromJSONTyped(json: any, ignoreDiscriminator: boolean): IbcCoreChannelV1Channel {
...
export function IbcCoreChannelV1ChannelToJSON(value?: IbcCoreChannelV1Channel | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
