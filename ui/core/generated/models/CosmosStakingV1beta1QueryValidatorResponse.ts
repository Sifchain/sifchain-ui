...
export function CosmosStakingV1beta1QueryValidatorResponseFromJSON(json: any): CosmosStakingV1beta1QueryValidatorResponse {
    return CosmosStakingV1beta1QueryValidatorResponseFromJSONTyped(json, false);
}

export function CosmosStakingV1beta1QueryValidatorResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CosmosStakingV1beta1QueryValidatorResponse {
...
export function CosmosStakingV1beta1QueryValidatorResponseToJSON(value?: CosmosStakingV1beta1QueryValidatorResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
