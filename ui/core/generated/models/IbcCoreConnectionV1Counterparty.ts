...
export function IbcCoreConnectionV1CounterpartyFromJSON(json: any): IbcCoreConnectionV1Counterparty {
    return IbcCoreConnectionV1CounterpartyFromJSONTyped(json, false);
}

export function IbcCoreConnectionV1CounterpartyFromJSONTyped(json: any, ignoreDiscriminator: boolean): IbcCoreConnectionV1Counterparty {
...
export function IbcCoreConnectionV1CounterpartyToJSON(value?: IbcCoreConnectionV1Counterparty | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
