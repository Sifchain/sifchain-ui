...
export function CosmosGovV1beta1QueryDepositsResponseFromJSON(json: any): CosmosGovV1beta1QueryDepositsResponse {
    return CosmosGovV1beta1QueryDepositsResponseFromJSONTyped(json, false);
}

export function CosmosGovV1beta1QueryDepositsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CosmosGovV1beta1QueryDepositsResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'deposits': !exists(json, 'deposits') ? undefined : ((json['deposits'] as Array<any>).map(InlineResponse20021DepositsFromJSON)),
        'pagination': !exists(json, 'pagination') ? undefined : InlineResponse2002PaginationFromJSON(json['pagination']),
    };
}

export function CosmosGovV1beta1QueryDepositsResponseToJSON(value?: CosmosGovV1beta1QueryDepositsResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'deposits': value.deposits === undefined ? undefined : ((value.deposits as Array<any>).map(InlineResponse20021DepositsToJSON)),
