...
export function IbcCoreChannelV1QueryConnectionChannelsResponseFromJSON(json: any): IbcCoreChannelV1QueryConnectionChannelsResponse {
    return IbcCoreChannelV1QueryConnectionChannelsResponseFromJSONTyped(json, false);
}

export function IbcCoreChannelV1QueryConnectionChannelsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): IbcCoreChannelV1QueryConnectionChannelsResponse {
...
export function IbcCoreChannelV1QueryConnectionChannelsResponseToJSON(value?: IbcCoreChannelV1QueryConnectionChannelsResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
