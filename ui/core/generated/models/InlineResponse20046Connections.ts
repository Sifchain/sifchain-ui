...
export function InlineResponse20046ConnectionsFromJSON(json: any): InlineResponse20046Connections {
    return InlineResponse20046ConnectionsFromJSONTyped(json, false);
}

export function InlineResponse20046ConnectionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse20046Connections {
...
export function InlineResponse20046ConnectionsToJSON(value?: InlineResponse20046Connections | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
