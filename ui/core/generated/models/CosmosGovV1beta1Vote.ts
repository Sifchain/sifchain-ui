...
export function CosmosGovV1beta1VoteFromJSONTyped(json: any, ignoreDiscriminator: boolean): CosmosGovV1beta1Vote {
...
export function CosmosGovV1beta1VoteToJSON(value?: CosmosGovV1beta1Vote | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
