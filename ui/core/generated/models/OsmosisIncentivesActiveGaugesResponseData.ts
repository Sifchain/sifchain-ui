...
export function OsmosisIncentivesActiveGaugesResponseDataFromJSON(json: any): OsmosisIncentivesActiveGaugesResponseData {
    return OsmosisIncentivesActiveGaugesResponseDataFromJSONTyped(json, false);
}

export function OsmosisIncentivesActiveGaugesResponseDataFromJSONTyped(json: any, ignoreDiscriminator: boolean): OsmosisIncentivesActiveGaugesResponseData {
...
export function OsmosisIncentivesActiveGaugesResponseDataToJSON(value?: OsmosisIncentivesActiveGaugesResponseData | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
