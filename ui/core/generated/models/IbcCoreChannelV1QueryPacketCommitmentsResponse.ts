...
export function IbcCoreChannelV1QueryPacketCommitmentsResponseFromJSON(json: any): IbcCoreChannelV1QueryPacketCommitmentsResponse {
    return IbcCoreChannelV1QueryPacketCommitmentsResponseFromJSONTyped(json, false);
}

export function IbcCoreChannelV1QueryPacketCommitmentsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): IbcCoreChannelV1QueryPacketCommitmentsResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'commitments': !exists(json, 'commitments') ? undefined : ((json['commitments'] as Array<any>).map(QueryPacketAcknowledgemetsResponseIsTheRequestTypeForTheQueryQueryPacketAcknowledgementsRPCMethodAcknowledgementsFromJSON)),
...
export function IbcCoreChannelV1QueryPacketCommitmentsResponseToJSON(value?: IbcCoreChannelV1QueryPacketCommitmentsResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'commitments': value.commitments === undefined ? undefined : ((value.commitments as Array<any>).map(QueryPacketAcknowledgemetsResponseIsTheRequestTypeForTheQueryQueryPacketAcknowledgementsRPCMethodAcknowledgementsToJSON)),
