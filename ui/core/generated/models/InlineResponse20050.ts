...
export function InlineResponse20050FromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse20050 {
...
export function InlineResponse20050ToJSON(value?: InlineResponse20050 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
