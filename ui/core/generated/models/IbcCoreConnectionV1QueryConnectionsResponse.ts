...
export function IbcCoreConnectionV1QueryConnectionsResponseFromJSON(json: any): IbcCoreConnectionV1QueryConnectionsResponse {
    return IbcCoreConnectionV1QueryConnectionsResponseFromJSONTyped(json, false);
}

export function IbcCoreConnectionV1QueryConnectionsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): IbcCoreConnectionV1QueryConnectionsResponse {
...
export function IbcCoreConnectionV1QueryConnectionsResponseToJSON(value?: IbcCoreConnectionV1QueryConnectionsResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
