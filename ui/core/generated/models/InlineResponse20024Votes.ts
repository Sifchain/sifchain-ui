...
export function InlineResponse20024VotesFromJSON(json: any): InlineResponse20024Votes {
    return InlineResponse20024VotesFromJSONTyped(json, false);
}

export function InlineResponse20024VotesFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse20024Votes {
...
export function InlineResponse20024VotesToJSON(value?: InlineResponse20024Votes | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
