...
export function IbcCoreConnectionV1IdentifiedConnectionFromJSON(json: any): IbcCoreConnectionV1IdentifiedConnection {
    return IbcCoreConnectionV1IdentifiedConnectionFromJSONTyped(json, false);
}

export function IbcCoreConnectionV1IdentifiedConnectionFromJSONTyped(json: any, ignoreDiscriminator: boolean): IbcCoreConnectionV1IdentifiedConnection {
...
export function IbcCoreConnectionV1IdentifiedConnectionToJSON(value?: IbcCoreConnectionV1IdentifiedConnection | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
