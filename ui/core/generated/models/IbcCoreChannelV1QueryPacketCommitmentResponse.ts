...
export function IbcCoreChannelV1QueryPacketCommitmentResponseFromJSON(json: any): IbcCoreChannelV1QueryPacketCommitmentResponse {
    return IbcCoreChannelV1QueryPacketCommitmentResponseFromJSONTyped(json, false);
}

export function IbcCoreChannelV1QueryPacketCommitmentResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): IbcCoreChannelV1QueryPacketCommitmentResponse {
...
export function IbcCoreChannelV1QueryPacketCommitmentResponseToJSON(value?: IbcCoreChannelV1QueryPacketCommitmentResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
