...
export function OsmosisIncentivesUpcomingGaugesResponseFromJSON(json: any): OsmosisIncentivesUpcomingGaugesResponse {
    return OsmosisIncentivesUpcomingGaugesResponseFromJSONTyped(json, false);
}

export function OsmosisIncentivesUpcomingGaugesResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): OsmosisIncentivesUpcomingGaugesResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'data': !exists(json, 'data') ? undefined : ((json['data'] as Array<any>).map(OsmosisIncentivesActiveGaugesResponseDataFromJSON)),
        'pagination': !exists(json, 'pagination') ? undefined : OsmosisIncentivesActiveGaugesResponsePaginationFromJSON(json['pagination']),
    };
}

export function OsmosisIncentivesUpcomingGaugesResponseToJSON(value?: OsmosisIncentivesUpcomingGaugesResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'data': value.data === undefined ? undefined : ((value.data as Array<any>).map(OsmosisIncentivesActiveGaugesResponseDataToJSON)),
        'pagination': OsmosisIncentivesActiveGaugesResponsePaginationToJSON(value.pagination),
    };
}
