...
export function OsmosisMintV1beta1QueryParamsResponseParamsFromJSON(json: any): OsmosisMintV1beta1QueryParamsResponseParams {
    return OsmosisMintV1beta1QueryParamsResponseParamsFromJSONTyped(json, false);
}

export function OsmosisMintV1beta1QueryParamsResponseParamsFromJSONTyped(json: any, ignoreDiscriminator: boolean): OsmosisMintV1beta1QueryParamsResponseParams {
...
export function OsmosisMintV1beta1QueryParamsResponseParamsToJSON(value?: OsmosisMintV1beta1QueryParamsResponseParams | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
