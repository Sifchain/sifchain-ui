...
export function InlineResponse2004DenomUnitsFromJSON(json: any): InlineResponse2004DenomUnits {
    return InlineResponse2004DenomUnitsFromJSONTyped(json, false);
}

export function InlineResponse2004DenomUnitsFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse2004DenomUnits {
...
export function InlineResponse2004DenomUnitsToJSON(value?: InlineResponse2004DenomUnits | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
