...
export function IbcCoreChannelV1IdentifiedChannelFromJSON(json: any): IbcCoreChannelV1IdentifiedChannel {
    return IbcCoreChannelV1IdentifiedChannelFromJSONTyped(json, false);
}

export function IbcCoreChannelV1IdentifiedChannelFromJSONTyped(json: any, ignoreDiscriminator: boolean): IbcCoreChannelV1IdentifiedChannel {
...
export function IbcCoreChannelV1IdentifiedChannelToJSON(value?: IbcCoreChannelV1IdentifiedChannel | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
