...
export function IbcCoreChannelV1QueryNextSequenceReceiveResponseFromJSON(json: any): IbcCoreChannelV1QueryNextSequenceReceiveResponse {
    return IbcCoreChannelV1QueryNextSequenceReceiveResponseFromJSONTyped(json, false);
}

export function IbcCoreChannelV1QueryNextSequenceReceiveResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): IbcCoreChannelV1QueryNextSequenceReceiveResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'nextSequenceReceive': !exists(json, 'next_sequence_receive') ? undefined : json['next_sequence_receive'],
...
export function IbcCoreChannelV1QueryNextSequenceReceiveResponseToJSON(value?: IbcCoreChannelV1QueryNextSequenceReceiveResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
