...
export function CosmosBankV1beta1QueryDenomsMetadataResponseFromJSON(json: any): CosmosBankV1beta1QueryDenomsMetadataResponse {
    return CosmosBankV1beta1QueryDenomsMetadataResponseFromJSONTyped(json, false);
}

export function CosmosBankV1beta1QueryDenomsMetadataResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CosmosBankV1beta1QueryDenomsMetadataResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'metadatas': !exists(json, 'metadatas') ? undefined : ((json['metadatas'] as Array<any>).map(InlineResponse2004MetadatasFromJSON)),
        'pagination': !exists(json, 'pagination') ? undefined : InlineResponse2002PaginationFromJSON(json['pagination']),
    };
}

export function CosmosBankV1beta1QueryDenomsMetadataResponseToJSON(value?: CosmosBankV1beta1QueryDenomsMetadataResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'metadatas': value.metadatas === undefined ? undefined : ((value.metadatas as Array<any>).map(InlineResponse2004MetadatasToJSON)),
