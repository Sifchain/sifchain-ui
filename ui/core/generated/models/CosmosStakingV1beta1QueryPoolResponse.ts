...
export function CosmosStakingV1beta1QueryPoolResponseFromJSON(json: any): CosmosStakingV1beta1QueryPoolResponse {
    return CosmosStakingV1beta1QueryPoolResponseFromJSONTyped(json, false);
}

export function CosmosStakingV1beta1QueryPoolResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CosmosStakingV1beta1QueryPoolResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'pool': !exists(json, 'pool') ? undefined : InlineResponse20034PoolFromJSON(json['pool']),
    };
}

export function CosmosStakingV1beta1QueryPoolResponseToJSON(value?: CosmosStakingV1beta1QueryPoolResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
