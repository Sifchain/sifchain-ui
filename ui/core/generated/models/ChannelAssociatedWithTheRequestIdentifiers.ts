...
export function ChannelAssociatedWithTheRequestIdentifiersFromJSON(json: any): ChannelAssociatedWithTheRequestIdentifiers {
    return ChannelAssociatedWithTheRequestIdentifiersFromJSONTyped(json, false);
}

export function ChannelAssociatedWithTheRequestIdentifiersFromJSONTyped(json: any, ignoreDiscriminator: boolean): ChannelAssociatedWithTheRequestIdentifiers {
    ...
    return {
        ...
        'counterparty': !exists(json, 'counterparty') ? undefined : CounterpartyChannelEndFromJSON(json['counterparty']),
        'connectionHops': !exists(json, 'connection_hops') ? undefined : json['connection_hops'],
        'version': !exists(json, 'version') ? undefined : json['version'],
    };
}

export function ChannelAssociatedWithTheRequestIdentifiersToJSON(value?: ChannelAssociatedWithTheRequestIdentifiers | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
