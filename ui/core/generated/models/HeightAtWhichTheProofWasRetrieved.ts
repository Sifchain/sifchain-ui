...
export function HeightAtWhichTheProofWasRetrievedFromJSON(json: any): HeightAtWhichTheProofWasRetrieved {
    return HeightAtWhichTheProofWasRetrievedFromJSONTyped(json, false);
}

export function HeightAtWhichTheProofWasRetrievedFromJSONTyped(json: any, ignoreDiscriminator: boolean): HeightAtWhichTheProofWasRetrieved {
...
export function HeightAtWhichTheProofWasRetrievedToJSON(value?: HeightAtWhichTheProofWasRetrieved | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
