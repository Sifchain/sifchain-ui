...
export function CosmosDistributionV1beta1ParamsFromJSON(json: any): CosmosDistributionV1beta1Params {
    return CosmosDistributionV1beta1ParamsFromJSONTyped(json, false);
}

export function CosmosDistributionV1beta1ParamsFromJSONTyped(json: any, ignoreDiscriminator: boolean): CosmosDistributionV1beta1Params {
...
export function CosmosDistributionV1beta1ParamsToJSON(value?: CosmosDistributionV1beta1Params | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
