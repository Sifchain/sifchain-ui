...
export function InlineResponse20047FromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse20047 {
...
export function InlineResponse20047ToJSON(value?: InlineResponse20047 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
