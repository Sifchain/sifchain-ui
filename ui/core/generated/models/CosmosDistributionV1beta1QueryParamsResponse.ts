...
export function CosmosDistributionV1beta1QueryParamsResponseFromJSON(json: any): CosmosDistributionV1beta1QueryParamsResponse {
    return CosmosDistributionV1beta1QueryParamsResponseFromJSONTyped(json, false);
}

export function CosmosDistributionV1beta1QueryParamsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CosmosDistributionV1beta1QueryParamsResponse {
...
export function CosmosDistributionV1beta1QueryParamsResponseToJSON(value?: CosmosDistributionV1beta1QueryParamsResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
