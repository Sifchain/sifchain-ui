...
export function IbcApplicationsTransferV1QueryDenomTracesResponseFromJSON(json: any): IbcApplicationsTransferV1QueryDenomTracesResponse {
    return IbcApplicationsTransferV1QueryDenomTracesResponseFromJSONTyped(json, false);
}

export function IbcApplicationsTransferV1QueryDenomTracesResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): IbcApplicationsTransferV1QueryDenomTracesResponse {
...
export function IbcApplicationsTransferV1QueryDenomTracesResponseToJSON(value?: IbcApplicationsTransferV1QueryDenomTracesResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
