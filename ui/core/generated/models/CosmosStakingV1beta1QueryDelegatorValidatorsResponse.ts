...
export function CosmosStakingV1beta1QueryDelegatorValidatorsResponseFromJSON(json: any): CosmosStakingV1beta1QueryDelegatorValidatorsResponse {
    return CosmosStakingV1beta1QueryDelegatorValidatorsResponseFromJSONTyped(json, false);
}

export function CosmosStakingV1beta1QueryDelegatorValidatorsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CosmosStakingV1beta1QueryDelegatorValidatorsResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'validators': !exists(json, 'validators') ? undefined : ((json['validators'] as Array<any>).map(InlineResponse20030ValidatorsFromJSON)),
        'pagination': !exists(json, 'pagination') ? undefined : InlineResponse2002PaginationFromJSON(json['pagination']),
    };
}

export function CosmosStakingV1beta1QueryDelegatorValidatorsResponseToJSON(value?: CosmosStakingV1beta1QueryDelegatorValidatorsResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'validators': value.validators === undefined ? undefined : ((value.validators as Array<any>).map(InlineResponse20030ValidatorsToJSON)),
