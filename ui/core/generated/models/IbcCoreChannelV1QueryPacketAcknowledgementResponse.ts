...
export function IbcCoreChannelV1QueryPacketAcknowledgementResponseFromJSON(json: any): IbcCoreChannelV1QueryPacketAcknowledgementResponse {
    return IbcCoreChannelV1QueryPacketAcknowledgementResponseFromJSONTyped(json, false);
}

export function IbcCoreChannelV1QueryPacketAcknowledgementResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): IbcCoreChannelV1QueryPacketAcknowledgementResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'acknowledgement': !exists(json, 'acknowledgement') ? undefined : json['acknowledgement'],
...
export function IbcCoreChannelV1QueryPacketAcknowledgementResponseToJSON(value?: IbcCoreChannelV1QueryPacketAcknowledgementResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
