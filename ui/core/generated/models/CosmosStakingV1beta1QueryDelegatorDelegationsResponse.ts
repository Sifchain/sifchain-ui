...
export function CosmosStakingV1beta1QueryDelegatorDelegationsResponseFromJSON(json: any): CosmosStakingV1beta1QueryDelegatorDelegationsResponse {
    return CosmosStakingV1beta1QueryDelegatorDelegationsResponseFromJSONTyped(json, false);
}

export function CosmosStakingV1beta1QueryDelegatorDelegationsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CosmosStakingV1beta1QueryDelegatorDelegationsResponse {
...
export function CosmosStakingV1beta1QueryDelegatorDelegationsResponseToJSON(value?: CosmosStakingV1beta1QueryDelegatorDelegationsResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
