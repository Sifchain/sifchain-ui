...
export function InlineResponse20043FromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse20043 {
...
export function InlineResponse20043ToJSON(value?: InlineResponse20043 | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
