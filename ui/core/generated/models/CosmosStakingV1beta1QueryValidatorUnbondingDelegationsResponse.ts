...
export function CosmosStakingV1beta1QueryValidatorUnbondingDelegationsResponseFromJSON(json: any): CosmosStakingV1beta1QueryValidatorUnbondingDelegationsResponse {
    return CosmosStakingV1beta1QueryValidatorUnbondingDelegationsResponseFromJSONTyped(json, false);
}

export function CosmosStakingV1beta1QueryValidatorUnbondingDelegationsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CosmosStakingV1beta1QueryValidatorUnbondingDelegationsResponse {
...
export function CosmosStakingV1beta1QueryValidatorUnbondingDelegationsResponseToJSON(value?: CosmosStakingV1beta1QueryValidatorUnbondingDelegationsResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
