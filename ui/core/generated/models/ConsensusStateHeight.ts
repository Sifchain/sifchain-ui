...
export function ConsensusStateHeightFromJSONTyped(json: any, ignoreDiscriminator: boolean): ConsensusStateHeight {
...
export function ConsensusStateHeightToJSON(value?: ConsensusStateHeight | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
