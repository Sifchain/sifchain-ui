...
export function InlineResponse20041ChannelsFromJSON(json: any): InlineResponse20041Channels {
    return InlineResponse20041ChannelsFromJSONTyped(json, false);
}

export function InlineResponse20041ChannelsFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse20041Channels {
...
export function InlineResponse20041ChannelsToJSON(value?: InlineResponse20041Channels | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
