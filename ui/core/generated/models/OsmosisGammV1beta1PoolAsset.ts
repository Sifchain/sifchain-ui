...
export function OsmosisGammV1beta1PoolAssetFromJSON(json: any): OsmosisGammV1beta1PoolAsset {
    return OsmosisGammV1beta1PoolAssetFromJSONTyped(json, false);
}

export function OsmosisGammV1beta1PoolAssetFromJSONTyped(json: any, ignoreDiscriminator: boolean): OsmosisGammV1beta1PoolAsset {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'token': !exists(json, 'token') ? undefined : OsmosisGammV1beta1PoolAssetTokenFromJSON(json['token']),
        'weight': !exists(json, 'weight') ? undefined : json['weight'],
    };
}

export function OsmosisGammV1beta1PoolAssetToJSON(value?: OsmosisGammV1beta1PoolAsset | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
