...
export function CosmosStakingV1beta1QueryValidatorsResponseFromJSON(json: any): CosmosStakingV1beta1QueryValidatorsResponse {
    return CosmosStakingV1beta1QueryValidatorsResponseFromJSONTyped(json, false);
}

export function CosmosStakingV1beta1QueryValidatorsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CosmosStakingV1beta1QueryValidatorsResponse {
...
export function CosmosStakingV1beta1QueryValidatorsResponseToJSON(value?: CosmosStakingV1beta1QueryValidatorsResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
