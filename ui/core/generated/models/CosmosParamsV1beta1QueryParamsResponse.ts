...
export function CosmosParamsV1beta1QueryParamsResponseFromJSON(json: any): CosmosParamsV1beta1QueryParamsResponse {
    return CosmosParamsV1beta1QueryParamsResponseFromJSONTyped(json, false);
}

export function CosmosParamsV1beta1QueryParamsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CosmosParamsV1beta1QueryParamsResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'param': !exists(json, 'param') ? undefined : InlineResponse20026ParamFromJSON(json['param']),
    };
}

export function CosmosParamsV1beta1QueryParamsResponseToJSON(value?: CosmosParamsV1beta1QueryParamsResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
