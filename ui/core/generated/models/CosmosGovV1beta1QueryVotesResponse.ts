...
export function CosmosGovV1beta1QueryVotesResponseFromJSON(json: any): CosmosGovV1beta1QueryVotesResponse {
    return CosmosGovV1beta1QueryVotesResponseFromJSONTyped(json, false);
}

export function CosmosGovV1beta1QueryVotesResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CosmosGovV1beta1QueryVotesResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'votes': !exists(json, 'votes') ? undefined : ((json['votes'] as Array<any>).map(InlineResponse20024VotesFromJSON)),
        'pagination': !exists(json, 'pagination') ? undefined : InlineResponse2002PaginationFromJSON(json['pagination']),
    };
}

export function CosmosGovV1beta1QueryVotesResponseToJSON(value?: CosmosGovV1beta1QueryVotesResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'votes': value.votes === undefined ? undefined : ((value.votes as Array<any>).map(InlineResponse20024VotesToJSON)),
