...
export function CosmosEvidenceV1beta1QueryEvidenceResponseFromJSON(json: any): CosmosEvidenceV1beta1QueryEvidenceResponse {
    return CosmosEvidenceV1beta1QueryEvidenceResponseFromJSONTyped(json, false);
}

export function CosmosEvidenceV1beta1QueryEvidenceResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CosmosEvidenceV1beta1QueryEvidenceResponse {
...
export function CosmosEvidenceV1beta1QueryEvidenceResponseToJSON(value?: CosmosEvidenceV1beta1QueryEvidenceResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
