...
export function CosmosDistributionV1beta1QueryDelegationRewardsResponseFromJSON(json: any): CosmosDistributionV1beta1QueryDelegationRewardsResponse {
    return CosmosDistributionV1beta1QueryDelegationRewardsResponseFromJSONTyped(json, false);
}

export function CosmosDistributionV1beta1QueryDelegationRewardsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CosmosDistributionV1beta1QueryDelegationRewardsResponse {
...
export function CosmosDistributionV1beta1QueryDelegationRewardsResponseToJSON(value?: CosmosDistributionV1beta1QueryDelegationRewardsResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
