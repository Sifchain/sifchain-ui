...
export function InlineResponse20035DelegationResponseFromJSON(json: any): InlineResponse20035DelegationResponse {
    return InlineResponse20035DelegationResponseFromJSONTyped(json, false);
}

export function InlineResponse20035DelegationResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse20035DelegationResponse {
...
export function InlineResponse20035DelegationResponseToJSON(value?: InlineResponse20035DelegationResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
