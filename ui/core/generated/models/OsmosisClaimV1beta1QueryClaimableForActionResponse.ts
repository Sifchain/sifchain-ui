...
export function OsmosisClaimV1beta1QueryClaimableForActionResponseFromJSON(json: any): OsmosisClaimV1beta1QueryClaimableForActionResponse {
    return OsmosisClaimV1beta1QueryClaimableForActionResponseFromJSONTyped(json, false);
}

export function OsmosisClaimV1beta1QueryClaimableForActionResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): OsmosisClaimV1beta1QueryClaimableForActionResponse {
...
export function OsmosisClaimV1beta1QueryClaimableForActionResponseToJSON(value?: OsmosisClaimV1beta1QueryClaimableForActionResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
