...
export function CosmosEvidenceV1beta1QueryAllEvidenceResponseFromJSON(json: any): CosmosEvidenceV1beta1QueryAllEvidenceResponse {
    return CosmosEvidenceV1beta1QueryAllEvidenceResponseFromJSONTyped(json, false);
}

export function CosmosEvidenceV1beta1QueryAllEvidenceResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CosmosEvidenceV1beta1QueryAllEvidenceResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'evidence': !exists(json, 'evidence') ? undefined : ((json['evidence'] as Array<any>).map(InlineResponseDefaultDetailsFromJSON)),
        'pagination': !exists(json, 'pagination') ? undefined : InlineResponse2002PaginationFromJSON(json['pagination']),
    };
}

export function CosmosEvidenceV1beta1QueryAllEvidenceResponseToJSON(value?: CosmosEvidenceV1beta1QueryAllEvidenceResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'evidence': value.evidence === undefined ? undefined : ((value.evidence as Array<any>).map(InlineResponseDefaultDetailsToJSON)),
