...
export function IbcCoreClientV1QueryConsensusStateResponseFromJSON(json: any): IbcCoreClientV1QueryConsensusStateResponse {
    return IbcCoreClientV1QueryConsensusStateResponseFromJSONTyped(json, false);
}

export function IbcCoreClientV1QueryConsensusStateResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): IbcCoreClientV1QueryConsensusStateResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'consensusState': !exists(json, 'consensus_state') ? undefined : ConsensusStateAssociatedWithTheClientIdentifierAtTheGivenHeightFromJSON(json['consensus_state']),
...
export function IbcCoreClientV1QueryConsensusStateResponseToJSON(value?: IbcCoreClientV1QueryConsensusStateResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'consensus_state': ConsensusStateAssociatedWithTheClientIdentifierAtTheGivenHeightToJSON(value.consensusState),
        'proof': value.proof,
