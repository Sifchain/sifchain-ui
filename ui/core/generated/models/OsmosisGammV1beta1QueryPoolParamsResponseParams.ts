...
export function OsmosisGammV1beta1QueryPoolParamsResponseParamsFromJSON(json: any): OsmosisGammV1beta1QueryPoolParamsResponseParams {
    return OsmosisGammV1beta1QueryPoolParamsResponseParamsFromJSONTyped(json, false);
}

export function OsmosisGammV1beta1QueryPoolParamsResponseParamsFromJSONTyped(json: any, ignoreDiscriminator: boolean): OsmosisGammV1beta1QueryPoolParamsResponseParams {
    ...
    return {
        ...
        'smoothWeightChangeParams': !exists(json, 'smoothWeightChangeParams') ? undefined : (json['smoothWeightChangeParams']),
        'startTime': !exists(json, 'start_time') ? undefined : (new Date(json['start_time'])),
    };
}

export function OsmosisGammV1beta1QueryPoolParamsResponseParamsToJSON(value?: OsmosisGammV1beta1QueryPoolParamsResponseParams | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
