...
export function IbcCoreClientV1QueryClientStateResponseFromJSON(json: any): IbcCoreClientV1QueryClientStateResponse {
    return IbcCoreClientV1QueryClientStateResponseFromJSONTyped(json, false);
}

export function IbcCoreClientV1QueryClientStateResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): IbcCoreClientV1QueryClientStateResponse {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'clientState': !exists(json, 'client_state') ? undefined : ClientStateAssociatedWithTheRequestIdentifierFromJSON(json['client_state']),
...
export function IbcCoreClientV1QueryClientStateResponseToJSON(value?: IbcCoreClientV1QueryClientStateResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'client_state': ClientStateAssociatedWithTheRequestIdentifierToJSON(value.clientState),
        'proof': value.proof,
