...
export function InlineResponse20021DepositsFromJSON(json: any): InlineResponse20021Deposits {
    return InlineResponse20021DepositsFromJSONTyped(json, false);
}

export function InlineResponse20021DepositsFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse20021Deposits {
    ...
    return {
        ...
        'amount': !exists(json, 'amount') ? undefined : ((json['amount'] as Array<any>).map(InlineResponse2002BalancesFromJSON)),
    };
}

export function InlineResponse20021DepositsToJSON(value?: InlineResponse20021Deposits | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'amount': value.amount === undefined ? undefined : ((value.amount as Array<any>).map(InlineResponse2002BalancesToJSON)),
    };
}
