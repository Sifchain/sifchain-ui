...
export function CosmosBankV1beta1QueryDenomMetadataResponseFromJSON(json: any): CosmosBankV1beta1QueryDenomMetadataResponse {
    return CosmosBankV1beta1QueryDenomMetadataResponseFromJSONTyped(json, false);
}

export function CosmosBankV1beta1QueryDenomMetadataResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): CosmosBankV1beta1QueryDenomMetadataResponse {
...
export function CosmosBankV1beta1QueryDenomMetadataResponseToJSON(value?: CosmosBankV1beta1QueryDenomMetadataResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
