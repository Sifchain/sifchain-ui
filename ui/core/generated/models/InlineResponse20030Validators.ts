...
export function InlineResponse20030ValidatorsFromJSON(json: any): InlineResponse20030Validators {
    return InlineResponse20030ValidatorsFromJSONTyped(json, false);
}

export function InlineResponse20030ValidatorsFromJSONTyped(json: any, ignoreDiscriminator: boolean): InlineResponse20030Validators {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'operatorAddress': !exists(json, 'operator_address') ? undefined : json['operator_address'],
        'consensusPubkey': !exists(json, 'consensus_pubkey') ? undefined : InlineResponse20030ConsensusPubkeyFromJSON(json['consensus_pubkey']),
        'jailed': !exists(json, 'jailed') ? undefined : json['jailed'],
        'status': !exists(json, 'status') ? undefined : json['status'],
        'tokens': !exists(json, 'tokens') ? undefined : json['tokens'],
        'delegatorShares': !exists(json, 'delegator_shares') ? undefined : json['delegator_shares'],
        'description': !exists(json, 'description') ? undefined : InlineResponse20030DescriptionFromJSON(json['description']),
        'unbondingHeight': !exists(json, 'unbonding_height') ? undefined : json['unbonding_height'],
        'unbondingTime': !exists(json, 'unbonding_time') ? undefined : (new Date(json['unbonding_time'])),
        'commission': !exists(json, 'commission') ? undefined : InlineResponse20030CommissionFromJSON(json['commission']),
        'minSelfDelegation': !exists(json, 'min_self_delegation') ? undefined : json['min_self_delegation'],
    };
}

export function InlineResponse20030ValidatorsToJSON(value?: InlineResponse20030Validators | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'consensus_pubkey': InlineResponse20030ConsensusPubkeyToJSON(value.consensusPubkey),
        'jailed': value.jailed,
        'status': value.status,
        'tokens': value.tokens,
        ...
        'unbonding_time': value.unbondingTime === undefined ? undefined : (value.unbondingTime.toISOString()),
