...
export function OsmosisGammV1beta1SmoothWeightChangeParamsFromJSON(json: any): OsmosisGammV1beta1SmoothWeightChangeParams {
    return OsmosisGammV1beta1SmoothWeightChangeParamsFromJSONTyped(json, false);
}

export function OsmosisGammV1beta1SmoothWeightChangeParamsFromJSONTyped(json: any, ignoreDiscriminator: boolean): OsmosisGammV1beta1SmoothWeightChangeParams {
    ...
    return {
        ...
        'initialPoolWeights': !exists(json, 'initialPoolWeights') ? undefined : ((json['initialPoolWeights'] as Array<any>).map()),
        'targetPoolWeights': !exists(json, 'targetPoolWeights') ? undefined : ((json['targetPoolWeights'] as Array<any>).map()),
    };
}

export function OsmosisGammV1beta1SmoothWeightChangeParamsToJSON(value?: OsmosisGammV1beta1SmoothWeightChangeParams | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
    ...
    return {
        ...
        'initialPoolWeights': value.initialPoolWeights === undefined ? undefined : ((value.initialPoolWeights as Array<any>).map()),
        'targetPoolWeights': value.targetPoolWeights === undefined ? undefined : ((value.targetPoolWeights as Array<any>).map()),
    };
}
