...
function parseAsset(a) {
    return Asset(Object.assign(Object.assign({}, a), { displaySymbol: a.displaySymbol || a.symbol, label: parseLabel(a) }));
}
export function parseAssets(configAssets) {
    return configAssets.map(parseAsset);
}
export function parseConfig(config, assets, chainConfigsByNetwork, peggyCompatibleCosmosBaseDenoms) {
    var _a;
