 ...
 */
export function getMantissaFromDynamicMantissa(amount, hash) {
  const { infinity } = hash,
...
export function format(_amount, _asset, _options) {
  var _a, _b;
...
export function trimMantissa(decimal, integer = false) {
