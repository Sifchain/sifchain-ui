...
export function getConfig(applicationNetworkEnv = NetworkEnv.LOCALNET, sifchainAssetTag = "sifchain.localnet", ethereumAssetTag = "ethereum.localnet") {
    const assetMap = {
    ...
    const configMap = {
        localnet: parseConfig(localnetconfig, allAssets, chainConfigByNetworkEnv[NetworkEnv.LOCALNET], peggyCompatibleCosmosBaseDenoms),
        devnet: parseConfig(devnetconfig, allAssets, chainConfigByNetworkEnv[NetworkEnv.DEVNET], peggyCompatibleCosmosBaseDenoms),
        devnet_042: parseConfig(devnet042config, allAssets, chainConfigByNetworkEnv[NetworkEnv.DEVNET_042], peggyCompatibleCosmosBaseDenoms),
        testnet: parseConfig(testnetconfig, allAssets, chainConfigByNetworkEnv[NetworkEnv.TESTNET], peggyCompatibleCosmosBaseDenoms),
        mainnet: parseConfig(mainnnetconfig, allAssets, chainConfigByNetworkEnv[NetworkEnv.MAINNET], peggyCompatibleCosmosBaseDenoms),
        testnet_042_ibc: parseConfig(testnet042ibcconfig, allAssets, chainConfigByNetworkEnv[NetworkEnv.TESTNET_042_IBC], peggyCompatibleCosmosBaseDenoms),
    };
