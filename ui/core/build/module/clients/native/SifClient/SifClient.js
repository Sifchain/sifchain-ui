...
export class SifClient extends Compatible42SigningCosmosClient {
    constructor(apiUrl, senderAddress, signer, wsUrl, rpcUrl, gasPrice, gasLimits, broadcastMode = BroadcastMode.Block) {
        super(apiUrl, senderAddress, signer, gasPrice, gasLimits, broadcastMode);
        this.rpcUrl = rpcUrl;
        this.wallet = signer;
        this.unsignedClient = new SifUnSignedClient(apiUrl, wsUrl, rpcUrl, broadcastMode);
    }
    getRpcUrl() {
        return this.rpcUrl;
    }
