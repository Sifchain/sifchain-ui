...
import { Network, Asset, AssetAmount, fromBaseUnits, toBaseUnits, } from "../../";
    ...
    const loadTokenRegistry = () => __awaiter(void 0, void 0, void 0, function* () {
        if (!tokenRegistryPromise) {
            tokenRegistryPromise = (() => __awaiter(void 0, void 0, void 0, function* () {
                var _a, _b;
                const dex = yield NativeDexClient.connect(context.sifRpcUrl, context.sifApiUrl, context.sifChainId);
    ...
    const self = {
        ...
        loadCounterpartyAsset(nativeAsset) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                return Asset(Object.assign(Object.assign({}, nativeAsset), { symbol: counterpartyEntry.denom, decimals: +counterpartyEntry.decimals }));
            });
        },
        loadNativeAsset(counterpartyAsset) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                return Asset(Object.assign(Object.assign({}, counterpartyAsset), { symbol: nativeEntry.denom, decimals: +nativeEntry.decimals }));
            });
        },
        loadCounterpartyAssetAmount: (nativeAssetAmount) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const decimalAmount = fromBaseUnits(nativeAssetAmount.amount.toString(), nativeAssetAmount.asset);
        ...
        loadNativeAssetAmount: (assetAmount) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const decimalAmount = fromBaseUnits(assetAmount.amount.toString(), assetAmount.asset);
