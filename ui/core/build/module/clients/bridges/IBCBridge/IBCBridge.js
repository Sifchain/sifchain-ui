...
export class IBCBridge extends BaseBridge {
  ...
  loadQueryClientByNetwork(network) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const tendermintClient = yield Tendermint34Client.connect(
  ...
  bridgeTokens(
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const receivingStargateCient = yield SigningStargateClient === null ||
      SigningStargateClient === void 0
        ? void 0
      ...
      const timeoutHeight = yield getTransferTimeoutData(
      ...
      const client = yield NativeDexClient.connect(
        sifConfig.rpcUrl,
        sifConfig.restUrl,
        sifConfig.chainId,
      );
        ...
        try {
          ...
          const txDraft = new NativeDexTransaction(params.fromAddress, batch, {
            price: {
              ...
              amount:
                ((_a = fromChainConfig.keplrChainInfo.gasPriceStep) === null ||
                _a === void 0
                  ? void 0
                  : _a.high.toString()) ||
  ...
  waitForTransferComplete(provider, tx, onUpdate) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const client = yield SigningStargateClient === null ||
      SigningStargateClient === void 0
        ? void 0
        : SigningStargateClient.connectWithSigner(
            config.rpcUrl,
