...
export class BaseLiquidityClient {
    ...
    getNativeDexClient() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.nativeDexClientPromise) {
                this.nativeDexClientPromise = NativeDexClient.connectByChain(this.nativeChain);
            }
    ...
    fetchAllPools() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return res.pools
                ...
                if (!asset)
                    return null;
                return Pool(AssetAmount(this.nativeChain.nativeAsset, pool.nativeAssetBalance), AssetAmount(asset, pool.externalAssetBalance), Amount(pool.poolUnits));
            })
                .filter((i) => i != null);
        });
    }
    ...
    fetchPool(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!(poolRes === null || poolRes === void 0 ? void 0 : poolRes.pool))
                return;
            const pool = Pool(AssetAmount(this.nativeChain.nativeAsset, poolRes.pool.nativeAssetBalance || "0"), AssetAmount(params.asset, poolRes.pool.externalAssetBalance || "0"), Amount(poolRes.pool.poolUnits));
            return pool;
        });
    }
    /*
    ...
    fetchLiquidityProvider(params) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return LiquidityProvider(params.asset, Amount(((_a = res.liquidityProvider) === null || _a === void 0 ? void 0 : _a.liquidityProviderUnits) || "0"), params.address, Amount(res.nativeAssetBalance), Amount(res.externalAssetBalance));
        });
    }
}
