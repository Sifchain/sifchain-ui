...
export class Web3WalletProvider extends WalletProvider {
    ...
    getRequiredApprovalAmount(chain, tx, assetAmount) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const web3 = yield this.getWeb3();
            const tokenContract = new web3.eth.Contract(erc20TokenAbi, assetAmount.address);
            ...
            const hasAlreadyApprovedSpend = yield tokenContract.methods
                ...
                .call();
            if (JSBI.lessThan(JSBI.BigInt(hasAlreadyApprovedSpend), assetAmount.toBigInt())) {
                return assetAmount;
            }
            return AssetAmount(assetAmount.asset, "0");
        });
    ...
    approve(chain, tx, amount) {
        return __awaiter(this, void 0, void 0, function* () {
            const web3 = yield this.getWeb3();
            const tokenContract = new web3.eth.Contract(erc20TokenAbi, amount.asset.address);
    ...
    fetchBalance(chain, address, symbol) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const contract = new web3.eth.Contract(erc20TokenAbi, asset.address.toLowerCase());
            let amount = "0";
            try {
