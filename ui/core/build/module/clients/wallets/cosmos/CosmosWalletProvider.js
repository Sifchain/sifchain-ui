...
import { SigningStargateClient, QueryClient, setupIbcExtension, setupBankExtension, setupAuthExtension, } from "@cosmjs/stargate";
...
export class CosmosWalletProvider extends WalletProvider {
    constructor(context) {
        super();
        this.context = context;
        this.createIBCHash = createIBCHash;
    ...
    getStargateClient(chain) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return SigningStargateClient === null || SigningStargateClient === void 0 ? void 0 : SigningStargateClient.connectWithSigner(chainConfig.rpcUrl, sendingSigner, {
                gasLimits: {
                    send: 80000,
                    ibcTransfer: 120000,
                    delegate: 250000,
    ...
    getQueryClient(chain) {
        return __awaiter(this, void 0, void 0, function* () {
            const chainConfig = this.getIBCChainConfig(chain);
            const tendermintClient = yield Tendermint34Client.connect(chainConfig.rpcUrl);
            return QueryClient.withExtensions(tendermintClient, setupIbcExtension, setupBankExtension, setupAuthExtension);
        });
    }
    ...
    getIBCDenomTracesLookup(chain) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const denomTracesRestPromise = (() => __awaiter(this, void 0, void 0, function* () {
                try {
                    const denomTracesRes = yield fetch(`${chainConfig.restUrl}/ibc/applications/transfer/v1beta1/denom_traces`);
            ...
            for (let denomTrace of denomTraces.denomTraces) {
                ...
                const hash = yield createIBCHash(port, channelIds[0], denomTrace.baseDenom);
            ...
            for (let coin of balances) {
                ...
                if (!coin.denom.startsWith("ibc/")) {
                    ...
                    try {
                        ...
                        const assetAmount = yield this.tokenRegistry.loadNativeAssetAmount(AssetAmount(asset || coin.denom, coin.amount));
