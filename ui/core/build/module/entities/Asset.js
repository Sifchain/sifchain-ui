...
function isAsset(value) {
  return (
    typeof (value === null || value === void 0 ? void 0 : value.symbol) ===
      "string" &&
    typeof (value === null || value === void 0 ? void 0 : value.decimals) ===
      "number"
  );
}
export function Asset(assetOrSymbol) {
  ...
  if (isAsset(assetOrSymbol)) {
    ...
    assetMap.set(
      key,
      Object.assign(Object.assign({}, assetOrSymbol), {
