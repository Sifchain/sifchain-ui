...
import { DistributionRecords, Distribution, UserClaim, distributionStatusFromJSON, distributionStatusToJSON, distributionTypeFromJSON, distributionTypeToJSON, } from "../../../sifnode/dispensation/v1/types";
...
const baseQueryAllDistributionsResponse = { height: Long.ZERO };
...
const baseQueryRecordsByRecipientAddrResponse = { height: Long.ZERO };
...
const baseQueryClaimsResponse = { height: Long.ZERO };
