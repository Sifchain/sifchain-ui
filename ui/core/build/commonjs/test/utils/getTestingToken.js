...
exports.getBalance =
  exports.getTestingTokens =
  exports.getTestingToken =
    void 0;
const assets_ethereum_localnet_json_1 = __importDefault(
  require("../../config/networks/ethereum/assets.ethereum.localnet.json"),
);
const assets_sifchain_localnet_1 = __importDefault(
  require("../../config/networks/sifchain/assets.sifchain.localnet"),
);
...
function getTestingToken(tokenSymbol) {
  const supportedTokens = (0, parseConfig_1.parseAssets)(assets).map(
    (asset) => {
