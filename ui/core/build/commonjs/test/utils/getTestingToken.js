...
const assets_ethereum_localnet_json_1 = __importDefault(require("../../config/networks/ethereum/assets.ethereum.localnet.json"));
const assets_sifchain_localnet_1 = __importDefault(require("../../config/networks/sifchain/assets.sifchain.localnet"));
const parseConfig_1 = require("../../utils/parseConfig");
const entities_1 = require("../../entities");
const assets = [...assets_ethereum_localnet_json_1.default.assets, ...assets_sifchain_localnet_1.default.assets];
function getTestingToken(tokenSymbol) {
    const supportedTokens = (0, parseConfig_1.parseAssets)(assets).map((asset) => {
