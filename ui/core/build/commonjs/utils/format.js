...
exports.trimMantissa = exports.format = exports.formatAssetAmount = exports.round = exports.getMantissaFromDynamicMantissa = void 0;
...
function round(decimal, places) {
    return (0, decimalShift_1.decimalShift)((0, Amount_1.Amount)(decimal)
        .multiply((0, Amount_1.Amount)((0, decimalShift_1.decimalShift)("1", places)))
...
function format(_amount, _asset, _options) {
    ...
    let decimal = asset
        ? (0, decimalShift_1.decimalShift)(amount.toBigInt().toString(), -1 * asset.decimals)
        : amount.toString();
