...
exports.trimMantissa =
  exports.format =
  exports.formatAssetAmount =
  exports.round =
  exports.getMantissaFromDynamicMantissa =
    void 0;
...
function isAsset(val) {
  return (
    !!val &&
    typeof (val === null || val === void 0 ? void 0 : val.symbol) === "string"
  );
}
/**
...
function round(decimal, places) {
  return (0, decimalShift_1.decimalShift)(
    (0, Amount_1.Amount)(decimal)
      .multiply(
        (0, Amount_1.Amount)((0, decimalShift_1.decimalShift)("1", places)),
      )
...
function formatAssetAmount(value) {
  ...
  return amount.greaterThan((0, decimalShift_1.toBaseUnits)("100000", asset))
...
function format(_amount, _asset, _options) {
  ...
  if (options.shorthand) {
    return (0, numbro_1.default)(decimal).format(createNumbroConfig(options));
  }
  if (options.space) {
    space = " ";
  }
  if (options.mode === "percent") {
    decimal = (0, decimalShift_1.decimalShift)(decimal, 2);
    postfix = "%";
  }
...
function isShorthandWithTotalLength(val) {
  return (
    (val === null || val === void 0 ? void 0 : val.shorthand) &&
    (val === null || val === void 0 ? void 0 : val.totalLength)
  );
}
function createNumbroConfig(options) {
  ...
  return Object.assign(
    {
      forceSign:
        (_a = options.forceSign) !== null && _a !== void 0 ? _a : false,
      output: (_b = options.mode) !== null && _b !== void 0 ? _b : "number",
      thousandSeparated:
        (_c = options.separator) !== null && _c !== void 0 ? _c : false,
      spaceSeparated:
        (_d = options.space) !== null && _d !== void 0 ? _d : false,
      prefix: (_e = options.prefix) !== null && _e !== void 0 ? _e : "",
      postfix: (_f = options.postfix) !== null && _f !== void 0 ? _f : "",
    },
    isShorthandWithTotalLength(options)
      ? {
          average:
            (_g = options.shorthand) !== null && _g !== void 0 ? _g : false,
          totalLength: options.totalLength,
        }
      : {
          average:
            (_h = options.shorthand) !== null && _h !== void 0 ? _h : false,
