...
function Pool(a, b, poolUnits) {
    const pair = (0, Pair_1.Pair)(a, b);
    ...
    return {
        ...
        poolUnits: poolUnits ||
            (0, formulae_1.calculatePoolUnits)((0, Amount_1.Amount)(a), (0, Amount_1.Amount)(b), (0, Amount_1.Amount)("0"), (0, Amount_1.Amount)("0"), (0, Amount_1.Amount)("0")),
        priceAsset(asset) {
            return this.calcSwapResult((0, AssetAmount_1.AssetAmount)(asset, "1"));
        },
        calcProviderFee(x) {
            ...
            const providerFee = (0, formulae_1.calculateProviderFee)(x, X, Y);
            return (0, AssetAmount_1.AssetAmount)(this.otherAsset(x), providerFee);
        },
        calcPriceImpact(x) {
            const X = amounts.find((a) => a.symbol === x.symbol);
            if (!X)
                throw new Error(`Sent amount with symbol ${x.symbol} does not exist in this pair: ${this.toString()}`);
            return (0, formulae_1.calculatePriceImpact)(x, X).multiply("100");
        },
        ...
        calcSwapResult(x) {
            ...
            if (!Y)
                throw new Error("Pool does not have an opposite asset."); // For Typescript's sake will probably never happen
            const swapAmount = (0, formulae_1.calculateSwapResult)(x, X, Y);
            return (0, AssetAmount_1.AssetAmount)(this.otherAsset(x), swapAmount);
        },
        calcReverseSwapResult(Sa) {
            ...
            if (Sa.equalTo("0")) {
                return (0, AssetAmount_1.AssetAmount)(otherAsset, "0");
            }
            const x = (0, formulae_1.calculateReverseSwapResult)(Sa, Xa, Ya);
            return (0, AssetAmount_1.AssetAmount)(otherAsset, x);
        },
        calculatePoolUnits(nativeAssetAmount, externalAssetAmount) {
            ...
            const lpUnits = (0, formulae_1.calculatePoolUnits)(nativeAssetAmount, externalAssetAmount, nativeBalanceBefore, externalBalanceBefore, this.poolUnits);
...
function CompositePool(pair1, pair2) {
    ...
    return {
        ...
        getAmount: (asset) => {
            if ((0, Asset_1.Asset)(asset).symbol === nativeSymbol) {
        ...
        calcProviderFee(x) {
            ...
            return (0, AssetAmount_1.AssetAmount)(second.otherAsset(firstSwapFee), firstSwapFeeInOutputAsset.add(secondSwapFee));
        },
        calcPriceImpact(x) {
            const [first, second] = pair1.contains(x)
                ? [pair1, pair2]
