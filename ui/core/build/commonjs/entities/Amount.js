...
exports.isAmount = exports.Amount = void 0;
...
function Amount(source) {
  ...
  if (
    !(source instanceof jsbi_1.default) &&
    typeof source !== "bigint" &&
    typeof source !== "string"
  ) {
    if ((0, AssetAmount_1.isAssetAmount)(source)) {
...
function getQuotientWithBankersRounding(fraction) {
  ...
  if (
    jsbi_1.default.greaterThan(
      jsbi_1.default.multiply(rem, jsbi_1.default.BigInt("2")),
      bAbs,
    )
  ) {
    result = jsbi_1.default.add(result, jsbi_1.default.BigInt("1"));
  } else if (
    jsbi_1.default.equal(
      jsbi_1.default.multiply(rem, jsbi_1.default.BigInt("2")),
      bAbs,
    )
  ) {
    if (
      jsbi_1.default.equal(
        jsbi_1.default.remainder(result, jsbi_1.default.BigInt("2")),
        jsbi_1.default.BigInt("1"),
      )
    ) {
      result = jsbi_1.default.add(result, jsbi_1.default.BigInt("1"));
    }
  ...
  if (
    jsbi_1.default.greaterThan(a, jsbi_1.default.BigInt("0")) !==
...
function getAmountFromDecimal(decimal) {
  return Amount(
    (0, decimalShift_1.floorDecimal)(
      (0, decimalShift_1.decimalShift)(decimal, 18),
    ),
...
function toBig(fraction) {
  return (0, big_js_1.default)(fraction.toFixed(24));
}
