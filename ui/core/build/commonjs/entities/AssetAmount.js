...
function AssetAmount(asset, amount) {
  var _a, _b;
  const _asset =
    ((_a = asset) === null || _a === void 0 ? void 0 : _a.asset) ||
    (0, Asset_1.Asset)(asset);
  const _amount =
    ((_b = amount) === null || _b === void 0 ? void 0 : _b.amount) ||
    (0, Amount_1.Amount)(amount);
  ...
  const instance = {
    ...
    toDerived() {
      return _amount.multiply((0, decimalShift_1.fromBaseUnits)("1", _asset));
    },
    toBigInt() {
...
function isAssetAmount(value) {
  return (
    (value === null || value === void 0 ? void 0 : value.asset) &&
    (value === null || value === void 0 ? void 0 : value.amount)
  );
}
