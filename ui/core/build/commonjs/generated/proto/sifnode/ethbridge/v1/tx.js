...
exports.MsgLock = {
  ...
  fromJSON(object) {
    ...
    if (
      ...
      message.ethereumChainId = long_1.default.fromString(
        object.ethereumChainId,
      );
    } else {
...
exports.MsgCreateEthBridgeClaim = {
  ...
  decode(input, length) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.ethBridgeClaim = types_1.EthBridgeClaim.decode(
            reader,
            reader.uint32(),
          );
          break;
  ...
  fromJSON(object) {
    ...
    if (object.ethBridgeClaim !== undefined && object.ethBridgeClaim !== null) {
      message.ethBridgeClaim = types_1.EthBridgeClaim.fromJSON(
  ...
  fromPartial(object) {
    const message = Object.assign({}, baseMsgCreateEthBridgeClaim);
    if (object.ethBridgeClaim !== undefined && object.ethBridgeClaim !== null) {
      message.ethBridgeClaim = types_1.EthBridgeClaim.fromPartial(
        object.ethBridgeClaim,
      );
    } else {
      message.ethBridgeClaim = undefined;
...
class MsgClientImpl {
  ...
  Lock(request) {
    ...
    return promise.then((data) =>
      exports.MsgLockResponse.decode(new minimal_1.default.Reader(data)),
    );
  }
  Burn(request) {
    ...
    return promise.then((data) =>
      exports.MsgBurnResponse.decode(new minimal_1.default.Reader(data)),
    );
  }
  CreateEthBridgeClaim(request) {
    ...
    return promise.then((data) =>
      exports.MsgCreateEthBridgeClaimResponse.decode(
  ...
  UpdateWhiteListValidator(request) {
    ...
    return promise.then((data) =>
      exports.MsgUpdateWhiteListValidatorResponse.decode(
        new minimal_1.default.Reader(data),
      ),
    );
  }
  UpdateCethReceiverAccount(request) {
    ...
    return promise.then((data) =>
      exports.MsgUpdateCethReceiverAccountResponse.decode(
        new minimal_1.default.Reader(data),
      ),
    );
  }
  RescueCeth(request) {
    ...
    return promise.then((data) =>
      exports.MsgRescueCethResponse.decode(new minimal_1.default.Reader(data)),
    );
  }
}
