...
class MsgClientImpl {
  ...
  RemoveLiquidity(request) {
    ...
    return promise.then((data) =>
      exports.MsgRemoveLiquidityResponse.decode(
  ...
  CreatePool(request) {
    ...
    return promise.then((data) =>
      exports.MsgCreatePoolResponse.decode(new minimal_1.default.Reader(data)),
    );
  }
  AddLiquidity(request) {
    ...
    return promise.then((data) =>
      exports.MsgAddLiquidityResponse.decode(
        new minimal_1.default.Reader(data),
      ),
    );
  }
  Swap(request) {
    ...
    return promise.then((data) =>
      exports.MsgSwapResponse.decode(new minimal_1.default.Reader(data)),
    );
  }
  DecommissionPool(request) {
    ...
    return promise.then((data) =>
      exports.MsgDecommissionPoolResponse.decode(
        new minimal_1.default.Reader(data),
      ),
    );
  }
