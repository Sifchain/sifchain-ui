...
exports.PoolsReq = {
  ...
  fromPartial(object) {
    const message = Object.assign({}, basePoolsReq);
    if (object.pagination !== undefined && object.pagination !== null) {
      message.pagination = pagination_1.PageRequest.fromPartial(
        object.pagination,
      );
    } else {
      message.pagination = undefined;
...
exports.PoolsRes = {
  ...
  fromJSON(object) {
    ...
    if (object.pagination !== undefined && object.pagination !== null) {
      message.pagination = pagination_1.PageResponse.fromJSON(
        object.pagination,
      );
    } else {
      message.pagination = undefined;
  ...
  toJSON(message) {
    ...
    if (message.pools) {
      obj.pools = message.pools.map((e) =>
        e ? types_1.Pool.toJSON(e) : undefined,
      );
    } else {
      obj.pools = [];
    }
  ...
  fromPartial(object) {
    ...
    if (object.pagination !== undefined && object.pagination !== null) {
      message.pagination = pagination_1.PageResponse.fromPartial(
        object.pagination,
      );
    } else {
      message.pagination = undefined;
...
exports.LiquidityProviderRes = {
  encode(message, writer = minimal_1.default.Writer.create()) {
    if (message.liquidityProvider !== undefined) {
      types_1.LiquidityProvider.encode(
  ...
  decode(input, length) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.liquidityProvider = types_1.LiquidityProvider.decode(
            reader,
            reader.uint32(),
          );
          break;
  ...
  fromJSON(object) {
    ...
    if (
      ...
      message.liquidityProvider = types_1.LiquidityProvider.fromJSON(
  ...
  fromPartial(object) {
    ...
    if (
      ...
      message.liquidityProvider = types_1.LiquidityProvider.fromPartial(
        object.liquidityProvider,
      );
    } else {
      message.liquidityProvider = undefined;
...
exports.LiquidityProviderDataRes = {
  encode(message, writer = minimal_1.default.Writer.create()) {
    for (const v of message.liquidityProviderData) {
      types_1.LiquidityProviderData.encode(
        v,
        writer.uint32(10).fork(),
      ).ldelim();
    }
      ...
      switch (tag >>> 3) {
        case 1:
          message.liquidityProviderData.push(
            types_1.LiquidityProviderData.decode(reader, reader.uint32()),
          );
          break;
        case 2:
          message.height = reader.int64();
  ...
  fromJSON(object) {
    ...
    if (
      ...
      for (const e of object.liquidityProviderData) {
        message.liquidityProviderData.push(
          types_1.LiquidityProviderData.fromJSON(e),
        );
      }
    }
    if (object.height !== undefined && object.height !== null) {
  ...
  toJSON(message) {
    ...
    if (message.liquidityProviderData) {
      obj.liquidityProviderData = message.liquidityProviderData.map((e) =>
        e ? types_1.LiquidityProviderData.toJSON(e) : undefined,
      );
    } else {
  ...
  fromPartial(object) {
    ...
    if (
      ...
      for (const e of object.liquidityProviderData) {
        message.liquidityProviderData.push(
          types_1.LiquidityProviderData.fromPartial(e),
        );
      }
    }
    if (object.height !== undefined && object.height !== null) {
...
exports.LiquidityProviderListRes = {
      ...
      switch (tag >>> 3) {
        case 1:
          message.liquidityProviders.push(
            types_1.LiquidityProvider.decode(reader, reader.uint32()),
          );
          break;
        case 2:
          message.height = reader.int64();
  ...
  toJSON(message) {
    ...
    if (message.liquidityProviders) {
      obj.liquidityProviders = message.liquidityProviders.map((e) =>
        e ? types_1.LiquidityProvider.toJSON(e) : undefined,
      );
    } else {
  ...
  fromPartial(object) {
    ...
    if (
      ...
      for (const e of object.liquidityProviders) {
        message.liquidityProviders.push(
          types_1.LiquidityProvider.fromPartial(e),
        );
      }
    }
    if (object.height !== undefined && object.height !== null) {
...
class QueryClientImpl {
  ...
  GetPool(request) {
    ...
    return promise.then((data) =>
      exports.PoolRes.decode(new minimal_1.default.Reader(data)),
    );
  }
  GetPools(request) {
    ...
    return promise.then((data) =>
      exports.PoolsRes.decode(new minimal_1.default.Reader(data)),
    );
  }
  GetLiquidityProvider(request) {
    ...
    return promise.then((data) =>
      exports.LiquidityProviderRes.decode(new minimal_1.default.Reader(data)),
    );
  }
  GetLiquidityProviderData(request) {
    ...
    return promise.then((data) =>
      exports.LiquidityProviderDataRes.decode(
  ...
  GetAssetList(request) {
    ...
    return promise.then((data) =>
      exports.AssetListRes.decode(new minimal_1.default.Reader(data)),
    );
  }
  GetLiquidityProviders(request) {
    ...
    return promise.then((data) =>
      exports.LiquidityProvidersRes.decode(new minimal_1.default.Reader(data)),
    );
  }
  GetLiquidityProviderList(request) {
    ...
    return promise.then((data) =>
      exports.LiquidityProviderListRes.decode(
        new minimal_1.default.Reader(data),
      ),
    );
  }
