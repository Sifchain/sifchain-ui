  ...
  toJSON(message) {
    ...
    message.asset !== undefined &&
      (obj.asset = message.asset
        ? exports.Asset.toJSON(message.asset)
        : undefined);
...
exports.LiquidityProviderData = {
  encode(message, writer = minimal_1.default.Writer.create()) {
    if (message.liquidityProvider !== undefined) {
      exports.LiquidityProvider.encode(
  ...
  decode(input, length) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.liquidityProvider = exports.LiquidityProvider.decode(
            reader,
            reader.uint32(),
          );
          break;
  ...
  fromJSON(object) {
    ...
    if (
      ...
      message.liquidityProvider = exports.LiquidityProvider.fromJSON(
  ...
  fromPartial(object) {
    ...
    if (
      ...
      message.liquidityProvider = exports.LiquidityProvider.fromPartial(
        object.liquidityProvider,
      );
    } else {
      message.liquidityProvider = undefined;
