...
exports.RegistryEntry =
  ...
  exports.permissionToJSON =
  exports.permissionFromJSON =
  exports.Permission =
      ...
      switch (tag >>> 3) {
        case 1:
          message.entries.push(
            exports.RegistryEntry.decode(reader, reader.uint32()),
          );
          break;
        default:
          reader.skipType(tag & 7);
  ...
  toJSON(message) {
    ...
    if (message.entries) {
      obj.entries = message.entries.map((e) =>
        e ? exports.RegistryEntry.toJSON(e) : undefined,
      );
    } else {
      obj.entries = [];
    }
