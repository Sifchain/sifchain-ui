...
class MsgClientImpl {
  ...
  Register(request) {
    ...
    return promise.then((data) =>
      exports.MsgRegisterResponse.decode(new minimal_1.default.Reader(data)),
    );
  }
  Deregister(request) {
    ...
    return promise.then((data) =>
      exports.MsgDeregisterResponse.decode(new minimal_1.default.Reader(data)),
    );
  }
  SetRegistry(request) {
    ...
    return promise.then((data) =>
      exports.MsgSetRegistryResponse.decode(new minimal_1.default.Reader(data)),
    );
  }
}
