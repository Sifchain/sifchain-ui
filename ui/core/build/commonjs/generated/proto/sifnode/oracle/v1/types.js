...
exports.Status =
  ...
  exports.statusTextToJSON =
  exports.statusTextFromJSON =
  exports.StatusText =
...
(function (StatusText) {
  ...
  StatusText[(StatusText["STATUS_TEXT_UNSPECIFIED"] = 0)] =
    "STATUS_TEXT_UNSPECIFIED";
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          message.prophecies.push(
            exports.DBProphecy.decode(reader, reader.uint32()),
          );
          break;
        default:
  ...
  toJSON(message) {
    ...
    if (message.prophecies) {
      obj.prophecies = message.prophecies.map((e) =>
        e ? exports.DBProphecy.toJSON(e) : undefined,
      );
    } else {
      obj.prophecies = [];
    }
  ...
  toJSON(message) {
    ...
    message.status !== undefined &&
      (obj.status = message.status
        ? exports.Status.toJSON(message.status)
        : undefined);
