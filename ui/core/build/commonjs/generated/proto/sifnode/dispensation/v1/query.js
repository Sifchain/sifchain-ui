      ...
      switch (tag >>> 3) {
        case 1:
          message.distributions.push(
            types_1.Distribution.decode(reader, reader.uint32()),
          );
          break;
        case 2:
  ...
  toJSON(message) {
    ...
    if (message.distributions) {
      obj.distributions = message.distributions.map((e) =>
        e ? types_1.Distribution.toJSON(e) : undefined,
      );
    } else {
      obj.distributions = [];
    }
...
exports.QueryRecordsByDistributionNameRequest = {
  ...
  fromJSON(object) {
    ...
    if (object.status !== undefined && object.status !== null) {
      message.status = (0, types_1.distributionStatusFromJSON)(object.status);
    } else {
      message.status = 0;
    }
    return message;
  ...
  toJSON(message) {
    ...
    message.status !== undefined &&
      (obj.status = (0, types_1.distributionStatusToJSON)(message.status));
    return obj;
  },
  fromPartial(object) {
    const message = Object.assign(
...
exports.QueryRecordsByDistributionNameResponse = {
  encode(message, writer = minimal_1.default.Writer.create()) {
    if (message.distributionRecords !== undefined) {
      types_1.DistributionRecords.encode(
  ...
  decode(input, length) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.distributionRecords = types_1.DistributionRecords.decode(
            reader,
            reader.uint32(),
          );
          break;
  ...
  fromJSON(object) {
    ...
    if (
      ...
      message.distributionRecords = types_1.DistributionRecords.fromJSON(
  ...
  fromPartial(object) {
    ...
    if (
      ...
      message.distributionRecords = types_1.DistributionRecords.fromPartial(
        object.distributionRecords,
      );
    } else {
      message.distributionRecords = undefined;
...
exports.QueryClaimsByTypeRequest = {
  ...
  fromJSON(object) {
    ...
    if (object.userClaimType !== undefined && object.userClaimType !== null) {
      message.userClaimType = (0, types_1.distributionTypeFromJSON)(
        object.userClaimType,
      );
    } else {
  ...
  toJSON(message) {
    ...
    message.userClaimType !== undefined &&
      (obj.userClaimType = (0, types_1.distributionTypeToJSON)(
        message.userClaimType,
      ));
    return obj;
  },
  fromPartial(object) {
  ...
  decode(input, length) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.claims.push(
            types_1.UserClaim.decode(reader, reader.uint32()),
          );
          break;
        case 2:
          message.height = reader.int64();
  ...
  toJSON(message) {
    ...
    if (message.claims) {
      obj.claims = message.claims.map((e) =>
        e ? types_1.UserClaim.toJSON(e) : undefined,
      );
    } else {
      obj.claims = [];
    }
...
class QueryClientImpl {
  ...
  AllDistributions(request) {
    ...
    return promise.then((data) =>
      exports.QueryAllDistributionsResponse.decode(
  ...
  RecordsByDistributionName(request) {
    const data =
      exports.QueryRecordsByDistributionNameRequest.encode(request).finish();
    const promise = this.rpc.request(
      "sifnode.dispensation.v1.Query",
    ...
    return promise.then((data) =>
      exports.QueryRecordsByDistributionNameResponse.decode(
        new minimal_1.default.Reader(data),
      ),
    );
  }
  RecordsByRecipient(request) {
    const data =
      exports.QueryRecordsByRecipientAddrRequest.encode(request).finish();
    const promise = this.rpc.request(
      "sifnode.dispensation.v1.Query",
      "RecordsByRecipient",
      data,
    ...
    return promise.then((data) =>
      exports.QueryRecordsByRecipientAddrResponse.decode(
        new minimal_1.default.Reader(data),
      ),
    );
  }
  ClaimsByType(request) {
    ...
    return promise.then((data) =>
      exports.QueryClaimsResponse.decode(new minimal_1.default.Reader(data)),
    );
  }
}
