...
exports.MsgCreateDistribution = {
  ...
  fromJSON(object) {
    ...
    if (
      ...
      message.distributionType = (0, types_1.distributionTypeFromJSON)(
  ...
  toJSON(message) {
    ...
    message.distributionType !== undefined &&
      (obj.distributionType = (0, types_1.distributionTypeToJSON)(
...
class MsgClientImpl {
  ...
  CreateDistribution(request) {
    ...
    return promise.then((data) =>
      exports.MsgCreateDistributionResponse.decode(
  ...
  CreateUserClaim(request) {
    ...
    return promise.then((data) =>
      exports.MsgCreateClaimResponse.decode(new minimal_1.default.Reader(data)),
    );
  }
  RunDistribution(request) {
    ...
    return promise.then((data) =>
      exports.MsgRunDistributionResponse.decode(
        new minimal_1.default.Reader(data),
      ),
    );
  }
