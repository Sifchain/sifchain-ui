...
exports.MsgCreateDistribution = {
    ...
    fromJSON(object) {
        ...
        if (object.distributionType !== undefined &&
            ...
            message.distributionType = (0, types_1.distributionTypeFromJSON)(object.distributionType);
        }
        else {
    ...
    toJSON(message) {
        ...
        message.distributionType !== undefined &&
            (obj.distributionType = (0, types_1.distributionTypeToJSON)(message.distributionType));
        if (message.output) {
...
exports.MsgCreateUserClaim = {
    ...
    fromJSON(object) {
        ...
        if (object.userClaimType !== undefined && object.userClaimType !== null) {
            message.userClaimType = (0, types_1.distributionTypeFromJSON)(object.userClaimType);
        }
        else {
    ...
    toJSON(message) {
        ...
        message.userClaimType !== undefined &&
            (obj.userClaimType = (0, types_1.distributionTypeToJSON)(message.userClaimType));
        return obj;
    },
    fromPartial(object) {
        const message = Object.assign({}, baseMsgCreateUserClaim);
