...
exports.UserClaims =
  ...
  exports.distributionStatusToJSON =
  exports.distributionStatusFromJSON =
  exports.DistributionStatus =
  exports.distributionTypeToJSON =
  exports.distributionTypeFromJSON =
...
(function (DistributionStatus) {
  ...
  DistributionStatus[
    (DistributionStatus["DISTRIBUTION_STATUS_UNSPECIFIED"] = 0)
  ] = "DISTRIBUTION_STATUS_UNSPECIFIED";
  /** DISTRIBUTION_STATUS_PENDING - Pending status */
  DistributionStatus[(DistributionStatus["DISTRIBUTION_STATUS_PENDING"] = 1)] =
    "DISTRIBUTION_STATUS_PENDING";
  /** DISTRIBUTION_STATUS_COMPLETED - Completed status */
  DistributionStatus[
    (DistributionStatus["DISTRIBUTION_STATUS_COMPLETED"] = 2)
  ] = "DISTRIBUTION_STATUS_COMPLETED";
  /** DISTRIBUTION_STATUS_FAILED - Failed status */
  DistributionStatus[(DistributionStatus["DISTRIBUTION_STATUS_FAILED"] = 3)] =
    "DISTRIBUTION_STATUS_FAILED";
  DistributionStatus[(DistributionStatus["UNRECOGNIZED"] = -1)] =
    "UNRECOGNIZED";
})(
  (DistributionStatus =
    exports.DistributionStatus || (exports.DistributionStatus = {})),
);
...
exports.GenesisState = {
  ...
  decode(input, length) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.distributionRecords = exports.DistributionRecords.decode(
            reader,
            reader.uint32(),
          );
          break;
        case 2:
          message.distributions = exports.Distributions.decode(
            reader,
            reader.uint32(),
          );
          break;
  ...
  fromJSON(object) {
    ...
    if (
      ...
      message.distributionRecords = exports.DistributionRecords.fromJSON(
    ...
    if (object.distributions !== undefined && object.distributions !== null) {
      message.distributions = exports.Distributions.fromJSON(
  ...
  fromPartial(object) {
    ...
    if (
      ...
      message.distributionRecords = exports.DistributionRecords.fromPartial(
        object.distributionRecords,
      );
    } else {
      message.distributionRecords = undefined;
    ...
    if (object.distributions !== undefined && object.distributions !== null) {
      message.distributions = exports.Distributions.fromPartial(
        object.distributions,
      );
    } else {
      message.distributions = undefined;
...
exports.DistributionRecord = {
  ...
  fromJSON(object) {
    ...
    if (
      ...
      message.distributionStartHeight = long_1.default.fromString(
    ...
    if (
      ...
      message.distributionCompletedHeight = long_1.default.fromString(
...
exports.DistributionRecords = {
      ...
      switch (tag >>> 3) {
        case 1:
          message.distributionRecords.push(
            exports.DistributionRecord.decode(reader, reader.uint32()),
          );
          break;
        default:
          reader.skipType(tag & 7);
  ...
  fromJSON(object) {
    ...
    if (
      ...
      for (const e of object.distributionRecords) {
        message.distributionRecords.push(
          exports.DistributionRecord.fromJSON(e),
        );
      }
    }
    return message;
  ...
  toJSON(message) {
    ...
    if (message.distributionRecords) {
      obj.distributionRecords = message.distributionRecords.map((e) =>
        e ? exports.DistributionRecord.toJSON(e) : undefined,
      );
    } else {
  ...
  fromPartial(object) {
    ...
    if (
      ...
      for (const e of object.distributionRecords) {
        message.distributionRecords.push(
          exports.DistributionRecord.fromPartial(e),
        );
      }
    }
    return message;
      ...
      switch (tag >>> 3) {
        case 1:
          message.distributions.push(
            exports.Distribution.decode(reader, reader.uint32()),
          );
          break;
        default:
          reader.skipType(tag & 7);
  ...
  toJSON(message) {
    ...
    if (message.distributions) {
      obj.distributions = message.distributions.map((e) =>
        e ? exports.Distribution.toJSON(e) : undefined,
      );
    } else {
      obj.distributions = [];
    }
...
exports.UserClaims = {
  ...
  decode(input, length) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.userClaims.push(
            exports.UserClaim.decode(reader, reader.uint32()),
          );
          break;
        default:
          reader.skipType(tag & 7);
  ...
  toJSON(message) {
    ...
    if (message.userClaims) {
      obj.userClaims = message.userClaims.map((e) =>
        e ? exports.UserClaim.toJSON(e) : undefined,
      );
    } else {
      obj.userClaims = [];
    }
