...
exports.GeneratedCodeInfo_Annotation =
  ...
  exports.fieldOptions_JSTypeToJSON =
  exports.fieldOptions_JSTypeFromJSON =
  exports.FieldOptions_JSType =
  exports.fieldOptions_CTypeToJSON =
  exports.fieldOptions_CTypeFromJSON =
  exports.FieldOptions_CType =
  exports.fileOptions_OptimizeModeToJSON =
  exports.fileOptions_OptimizeModeFromJSON =
  exports.FileOptions_OptimizeMode =
  exports.fieldDescriptorProto_LabelToJSON =
  exports.fieldDescriptorProto_LabelFromJSON =
  exports.FieldDescriptorProto_Label =
  exports.fieldDescriptorProto_TypeToJSON =
  exports.fieldDescriptorProto_TypeFromJSON =
  ...
  toJSON(message) {
    ...
    if (message.file) {
      obj.file = message.file.map((e) =>
        e ? exports.FileDescriptorProto.toJSON(e) : undefined,
      );
    } else {
      obj.file = [];
    }
...
exports.FileDescriptorProto = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 8:
          ...
          break;
        case 9:
          message.sourceCodeInfo = exports.SourceCodeInfo.decode(
            reader,
            reader.uint32(),
          );
          break;
  ...
  fromJSON(object) {
    ...
    if (object.sourceCodeInfo !== undefined && object.sourceCodeInfo !== null) {
      message.sourceCodeInfo = exports.SourceCodeInfo.fromJSON(
  ...
  toJSON(message) {
    ...
    if (message.messageType) {
      obj.messageType = message.messageType.map((e) =>
        e ? exports.DescriptorProto.toJSON(e) : undefined,
      );
    } else {
      obj.messageType = [];
    }
    if (message.enumType) {
      obj.enumType = message.enumType.map((e) =>
        e ? exports.EnumDescriptorProto.toJSON(e) : undefined,
      );
    } else {
      obj.enumType = [];
    }
    if (message.service) {
      obj.service = message.service.map((e) =>
        e ? exports.ServiceDescriptorProto.toJSON(e) : undefined,
      );
    } else {
      obj.service = [];
    }
    if (message.extension) {
      obj.extension = message.extension.map((e) =>
        e ? exports.FieldDescriptorProto.toJSON(e) : undefined,
      );
    } else {
      obj.extension = [];
    }
  ...
  fromPartial(object) {
    ...
    if (object.sourceCodeInfo !== undefined && object.sourceCodeInfo !== null) {
      message.sourceCodeInfo = exports.SourceCodeInfo.fromPartial(
        object.sourceCodeInfo,
      );
    } else {
      message.sourceCodeInfo = undefined;
  ...
  toJSON(message) {
    ...
    if (message.extensionRange) {
      obj.extensionRange = message.extensionRange.map((e) =>
        e ? exports.DescriptorProto_ExtensionRange.toJSON(e) : undefined,
      );
    } else {
      obj.extensionRange = [];
    }
    if (message.oneofDecl) {
      obj.oneofDecl = message.oneofDecl.map((e) =>
        e ? exports.OneofDescriptorProto.toJSON(e) : undefined,
      );
    } else {
      obj.oneofDecl = [];
    }
    ...
    if (message.reservedRange) {
      obj.reservedRange = message.reservedRange.map((e) =>
        e ? exports.DescriptorProto_ReservedRange.toJSON(e) : undefined,
      );
    } else {
      obj.reservedRange = [];
    }
...
exports.DescriptorProto_ExtensionRange = {
  ...
  fromPartial(object) {
    ...
    if (object.options !== undefined && object.options !== null) {
      message.options = exports.ExtensionRangeOptions.fromPartial(
        object.options,
      );
    } else {
      message.options = undefined;
...
exports.ExtensionRangeOptions = {
  ...
  toJSON(message) {
    ...
    if (message.uninterpretedOption) {
      obj.uninterpretedOption = message.uninterpretedOption.map((e) =>
        e ? exports.UninterpretedOption.toJSON(e) : undefined,
      );
    } else {
  ...
  fromPartial(object) {
    ...
    if (
      ...
      for (const e of object.uninterpretedOption) {
        message.uninterpretedOption.push(
          exports.UninterpretedOption.fromPartial(e),
        );
      }
    }
    return message;
  ...
  toJSON(message) {
    ...
    if (message.value) {
      obj.value = message.value.map((e) =>
        e ? exports.EnumValueDescriptorProto.toJSON(e) : undefined,
      );
    } else {
      obj.value = [];
    }
    ...
    if (message.reservedRange) {
      obj.reservedRange = message.reservedRange.map((e) =>
        e ? exports.EnumDescriptorProto_EnumReservedRange.toJSON(e) : undefined,
      );
    } else {
      obj.reservedRange = [];
    }
  ...
  toJSON(message) {
    ...
    if (message.method) {
      obj.method = message.method.map((e) =>
        e ? exports.MethodDescriptorProto.toJSON(e) : undefined,
      );
    } else {
      obj.method = [];
    }
...
exports.UninterpretedOption = {
  ...
  fromJSON(object) {
    ...
    if (
      ...
      message.positiveIntValue = long_1.default.fromString(
    ...
    if (
      ...
      message.negativeIntValue = long_1.default.fromString(
  ...
  toJSON(message) {
    ...
    if (message.name) {
      obj.name = message.name.map((e) =>
        e ? exports.UninterpretedOption_NamePart.toJSON(e) : undefined,
      );
    } else {
      obj.name = [];
    }
  ...
  toJSON(message) {
    ...
    if (message.location) {
      obj.location = message.location.map((e) =>
        e ? exports.SourceCodeInfo_Location.toJSON(e) : undefined,
      );
    } else {
      obj.location = [];
    }
...
exports.GeneratedCodeInfo = {
  ...
  toJSON(message) {
    ...
    if (message.annotation) {
      obj.annotation = message.annotation.map((e) =>
        e ? exports.GeneratedCodeInfo_Annotation.toJSON(e) : undefined,
      );
    } else {
      obj.annotation = [];
    }
  ...
  fromPartial(object) {
    ...
    if (object.annotation !== undefined && object.annotation !== null) {
      for (const e of object.annotation) {
        message.annotation.push(
          exports.GeneratedCodeInfo_Annotation.fromPartial(e),
        );
      }
    }
    return message;
