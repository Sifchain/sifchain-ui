...
class BaseLiquidityClient {
    ...
    getNativeDexClient() {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.nativeDexClientPromise) {
                this.nativeDexClientPromise = native_1.NativeDexClient.connectByChain(this.nativeChain);
            }
    ...
    fetchAllPools() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return res.pools
                ...
                if (!asset)
                    return null;
                return (0, entities_1.Pool)((0, entities_1.AssetAmount)(this.nativeChain.nativeAsset, pool.nativeAssetBalance), (0, entities_1.AssetAmount)(asset, pool.externalAssetBalance), (0, entities_1.Amount)(pool.poolUnits));
            })
                .filter((i) => i != null);
        });
    }
    ...
    fetchPool(params) {
        return __awaiter(this, void 0, void 0, function* () {
            const client = yield this.getNativeDexClient();
            const entry = yield this.tokenRegistry.findAssetEntryOrThrow(params.asset);
            const poolRes = yield client.query.clp.GetPool({
                symbol: entry.denom,
            });
            if (!(poolRes === null || poolRes === void 0 ? void 0 : poolRes.pool))
                return;
            const pool = (0, entities_1.Pool)((0, entities_1.AssetAmount)(this.nativeChain.nativeAsset, poolRes.pool.nativeAssetBalance || "0"), (0, entities_1.AssetAmount)(params.asset, poolRes.pool.externalAssetBalance || "0"), (0, entities_1.Amount)(poolRes.pool.poolUnits));
            return pool;
        });
    }
    /*
    ...
    fetchLiquidityProvider(params) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (0, entities_1.LiquidityProvider)(params.asset, (0, entities_1.Amount)(((_a = res.liquidityProvider) === null || _a === void 0 ? void 0 : _a.liquidityProviderUnits) || "0"), params.address, (0, entities_1.Amount)(res.nativeAssetBalance), (0, entities_1.Amount)(res.externalAssetBalance));
        });
    }
}
