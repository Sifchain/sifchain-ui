...
class SwapClient extends BaseLiquidityClient_1.BaseLiquidityClient {
  ...
  createSwapQuote(params) {
    const slippageAmount = (0, entities_1.Amount)(
      String(params.slippagePercent || exports.DEFAULT_SWAP_SLIPPAGE_PERCENT),
    );
    const compositePool =
    ...
    return {
      ...
      minimumReceived: (0, entities_1.AssetAmount)(
        toAmount,
        (0, entities_1.Amount)("1")
