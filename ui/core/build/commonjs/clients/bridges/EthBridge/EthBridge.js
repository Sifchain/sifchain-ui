...
class EthBridge extends BaseBridge_1.BaseBridge {
    ...
    estimateFees(provider, params) {
        if (params.toChain.network === entities_1.Network.ETHEREUM) {
            ...
            const feeNumber = (0, isOriginallySifchainNativeToken_1.isOriginallySifchainNativeToken)(params.assetAmount)
                ? "35370000000000000"
                : "35370000000000000";
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (wallet instanceof ethereum_1.Web3WalletProvider) {
                const tx = new native_1.NativeDexTransaction(params.fromAddress, [
                    new ethereum_1.Web3Transaction(this.context.bridgebankContractAddress),
                ]);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (wallet instanceof CosmosWalletProvider_1.CosmosWalletProvider) {
                ...
                try {
                    ...
                    const status = error;
                    throw new Error((0, parseTxFailure_1.parseEthereumTxFailure)(status).memo);
                }
            }
        });
    }
    exportToEth(provider, params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const tx = (0, isOriginallySifchainNativeToken_1.isOriginallySifchainNativeToken)(params.assetAmount.asset)
    ...
    importFromEth(provider, params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let lockOrBurnFn;
            if ((0, isOriginallySifchainNativeToken_1.isOriginallySifchainNativeToken)(params.assetAmount.asset)) {
                lockOrBurnFn = this.burnToSifchain;
            }
            else {
                lockOrBurnFn = this.lockToSifchain;
            }
            const pegTx = yield lockOrBurnFn.call(this, provider, params.toAddress, params.assetAmount, exports.ETH_CONFIRMATIONS);
            return pegTx;
        });
    }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (ethTx.toChain.network === entities_1.Network.SIFCHAIN) {
                ...
                return new Promise((resolve, reject) => {
                    const pegTx = this.createPegTx(provider, exports.ETH_CONFIRMATIONS, ethTx.assetAmount.asset.ibcDenom || ethTx.assetAmount.asset.symbol, ethTx.hash);
                    ...
                    (() => __awaiter(this, void 0, void 0, function* () {
                        ...
                        while (!done) {
                            const newCount = yield (0, confirmTx_1.getConfirmations)(web3, ethTx.hash);
                            ...
                            if (blockHeight > ethTx.startingHeight + exports.ETH_CONFIRMATIONS * 5) {
    ...
    createPegTx(provider, confirmations, symbol, txHash) {
        ...
        const emitter = (0, PegTxEventEmitter_1.createPegTxEventEmitter)(txHash, symbol);
    ...
    lockToSifchain(provider, sifRecipient, assetAmount, confirmations) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const bridgeBankContract = yield (0, bridgebankContract_1.getBridgeBankContract)(web3, this.context.sifChainId, this.context.bridgebankContractAddress);
