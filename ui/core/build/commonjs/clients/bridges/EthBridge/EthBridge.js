...
const PegTxEventEmitter_1 = require("../../bridges/EthBridge/PegTxEventEmitter");
const confirmTx_1 = require("../../bridges/EthBridge/confirmTx");
...
const ethereum_1 = require("../../wallets/ethereum");
...
class EthBridge extends BaseBridge_1.BaseBridge {
  ...
  assertValidBridgeParams(wallet, params) {
    if (
      ...
      if (!(wallet instanceof ethereum_1.Web3WalletProvider)) {
        throw new Error(
          "EthBridge must be called with a Web3WalletProvider when transfering from Ethereum to Sifchain",
        );
      }
    } else if (
      params.toChain.network === entities_1.Network.ETHEREUM &&
  ...
  estimateFees(provider, params) {
    if (params.toChain.network === entities_1.Network.ETHEREUM) {
      ...
      const feeNumber = (0,
      isOriginallySifchainNativeToken_1.isOriginallySifchainNativeToken)(
        params.assetAmount,
      )
        ? "35370000000000000"
        : "35370000000000000";
      return (0, entities_1.AssetAmount)(ceth, feeNumber);
    }
  }
  approveTransfer(wallet, params) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (wallet instanceof ethereum_1.Web3WalletProvider) {
        const tx = new native_1.NativeDexTransaction(params.fromAddress, [
          new ethereum_1.Web3Transaction(
        ...
        return wallet.approve(
          params.fromChain,
          tx,
          yield wallet.getRequiredApprovalAmount(
            params.fromChain,
            tx,
            params.assetAmount,
          ),
  ...
  transfer(wallet, params) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (wallet instanceof CosmosWalletProvider_1.CosmosWalletProvider) {
        ...
        if ((0, launchpad_1.isBroadcastTxFailure)(tx)) {
          throw new Error((0, parseTxFailure_1.parseTxFailure)(tx).memo);
        }
        ...
        try {
            ...
            Object.assign(
              {
                ...
                startingHeight,
                confirmCount: 0,
                completionConfirmCount: exports.ETH_CONFIRMATIONS,
              },
              params,
            ),
            {
          ...
          const status = error;
          throw new Error(
            (0, parseTxFailure_1.parseEthereumTxFailure)(status).memo,
          );
        }
      }
    });
  ...
  exportToEth(provider, params) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const client = yield native_1.NativeDexClient.connectByChain(nativeChain);
        ...
        ? client.tx.ethbridge.Lock(
            {
              ...
              ethereumChainId: long_1.default.fromString(
  ...
  importFromEth(provider, params) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      let lockOrBurnFn;
      if (
        (0, isOriginallySifchainNativeToken_1.isOriginallySifchainNativeToken)(
          params.assetAmount.asset,
        )
      ) {
      ...
      const pegTx = yield lockOrBurnFn.call(
        this,
        provider,
        params.toAddress,
        params.assetAmount,
        exports.ETH_CONFIRMATIONS,
      );
      return pegTx;
    });
  }
  waitForTransferComplete(provider, tx, onUpdateTx) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (ethTx.toChain.network === entities_1.Network.SIFCHAIN) {
        ...
        return new Promise((resolve, reject) => {
          ...
          (() =>
            __awaiter(this, void 0, void 0, function* () {
              ...
              while (!done) {
                const newCount = yield (0, confirmTx_1.getConfirmations)(
                  web3,
                  ethTx.hash,
                );
                if (newCount && newCount !== confirmCount) {
                  onUpdateTx === null || onUpdateTx === void 0
                    ? void 0
                ...
                if (
                  blockHeight >
                  ethTx.startingHeight + exports.ETH_CONFIRMATIONS * 5
                ) {
        ...
        const pastEvents = yield contract.getPastEvents(
          "Transfer",
          Object.assign(Object.assign({}, transferOptions), {
            toBlock: "latest",
          }),
        );
  ...
  createPegTx(provider, confirmations, symbol, txHash) {
    ...
    const emitter = (0, PegTxEventEmitter_1.createPegTxEventEmitter)(
      txHash,
      symbol,
    );
   ...
   */
  getEventTxsInBlockrangeFromAddress(
    provider,
    address,
    contract,
    eventList,
          ...
          ((_b =
            (_a =
              event === null || event === void 0
                ? void 0
                : event.returnValues) === null || _a === void 0
              ? void 0
              : _a._from) === null || _b === void 0
            ? void 0
            : _b.toLowerCase()) === address.toLowerCase();
        if (
          isEventWeCareAbout &&
          matchesInputAddress &&
          ...
          txs.push({
            ...
            symbol:
              (_c = event.returnValues) === null || _c === void 0
                ? void 0
                : _c._symbol,
          });
        }
        ...
        if (this.context.peggyCompatibleCosmosBaseDenoms.has(asset.symbol)) {
          if (!assetAddressMap.has(asset.symbol)) {
            try {
              assetAddressMap.set(
                asset.symbol,
                yield this.fetchTokenAddress(provider, asset),
              );
            } catch (e) {
              console.error(e);
            }
  ...
  lockToSifchain(provider, sifRecipient, assetAmount, confirmations) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      try {
        ...
        const bridgeBankContract = yield (0,
        bridgebankContract_1.getBridgeBankContract)(
          web3,
        ...
        const coinDenom =
          ...
          exports.ETH_ADDRESS; // eth address is ""
  ...
  fetchUnconfirmedLockBurnTxs(provider, address, confirmations) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const txs = yield this.getEventTxsInBlockrangeFromAddress(
        provider,
        address,
        bridgeBankContract,
        ["LogBurn", "LogLock"],
  ...
  fetchTokenAddress(
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      for (let symbol of possibleSymbols) {
        ...
        if (
          tokenAddress === exports.ETH_ADDRESS &&
