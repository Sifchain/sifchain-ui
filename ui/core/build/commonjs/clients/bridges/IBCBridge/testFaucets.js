...
const runAkashFaucet = (toAddress) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const signer = yield proto_signing_1.DirectSecp256k1HdWallet.fromMnemonic(
    ...
    const client = yield stargate_1.SigningStargateClient.connectWithSigner(
      akash_testnet_1.AKASH_TESTNET.rpcUrl,
      signer,
      {
        prefix: "akash",
      },
...
const runRowanFaucet = (sifAddress) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const useLocalFaucet = false;
    const faucetGql = (body) =>
      __awaiter(void 0, void 0, void 0, function* () {
        ...
        if (!res.ok) throw new Error("Error with faucet " + (yield res.text()));
