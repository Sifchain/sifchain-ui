...
class IBCBridge extends BaseBridge_1.BaseBridge {
    ...
    extractTransferMetadataFromTx(tx) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const sequence = (0, logs_1.findAttribute)(logs, "send_packet", "packet_sequence").value;
            const dstChannel = (0, logs_1.findAttribute)(logs, "send_packet", "packet_dst_channel").value;
            const dstPort = (0, logs_1.findAttribute)(logs, "send_packet", "packet_dst_port").value;
            const packet = (0, logs_1.findAttribute)(logs, "send_packet", "packet_data").value;
            const timeoutTimestampNanoseconds = (0, logs_1.findAttribute)(logs, "send_packet", "packet_timeout_timestamp").value;
            return {
                sequence,
                dstChannel,
                dstPort,
    ...
    checkIfPacketReceived(network, receivingChannelId, receivingPort, sequence) {
        return __awaiter(this, void 0, void 0, function* () {
            const didReceive = Promise.resolve()
                ...
                .catch((e) => {
                return (0, cross_fetch_1.fetch)(`${this.loadChainConfigByNetwork(network).restUrl}/ibc/core/channel/v1beta1/channels/${receivingChannelId}/ports/${receivingPort}/packet_receipts/${sequence}`).then((r) => r.json().then((res) => {
                    return res.received;
                }));
            });
            return didReceive;
    ...
    fetchTransferGasFee(fromChain) {
        return __awaiter(this, void 0, void 0, function* () {
            if (Date.now() - this.lastFetchedGasPricesAt > 5 * 60 * 1000) {
                try {
                    this.gasPrices = yield (0, cross_fetch_1.fetch)("https://gas-meter.vercel.app/gas-v1.json").then((r) => {
                        return r.json();
                    });
            ...
            return (0, entities_1.AssetAmount)(fromChain.nativeAsset, this.gasPrices[fromChain.chainConfig.chainId] ||
                native_1.NativeDexClient.feeTable.transfer.gas);
        });
    }
    ...
    { shouldBatchTransfers = false, maxMsgsPerBatch = 800, maxAmountPerMsg = `9223372036854775807`, gasPerBatch = undefined, } = {}) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const timeoutHeight = yield (0, getTransferTimeoutData_1.getTransferTimeoutData)(receivingStargateCient, this.transferTimeoutMinutes);
            if (!transferTokenEntry) {
                throw new Error("Invalid transfer symbol not in whitelist: " + symbol);
            }
            let transferDenom;
            const isEthereumAsset = params.assetAmount.homeNetwork === entities_1.Network.ETHEREUM ||
            ...
            params.fromChain.chainConfig.chainId ===
                ...
                (params.fromChain.network === entities_1.Network.SIFCHAIN && isEthereumAsset)) {
            ...
            const client = yield native_1.NativeDexClient.connect(sifConfig.rpcUrl, sifConfig.restUrl, sifConfig.chainId);
            if (!channelId)
            ...
            for (let batch of batches) {
                try {
                    ...
                    const txDraft = new native_1.NativeDexTransaction(params.fromAddress, batch, {
                        price: {
    ...
    waitForTransferComplete(provider, tx, onUpdate) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!logs)
                return false;
            const sequence = (0, logs_1.findAttribute)(logs, "send_packet", "packet_sequence");
            const dstChannel = (0, logs_1.findAttribute)(logs, "send_packet", "packet_dst_channel");
            const dstPort = (0, logs_1.findAttribute)(logs, "send_packet", "packet_dst_port");
            const timeoutHeight = (0, logs_1.findAttribute)(logs, "send_packet", "packet_timeout_height");
