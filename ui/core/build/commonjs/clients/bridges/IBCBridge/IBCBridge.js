...
const parseTxFailure_1 = require("../../../utils/parseTxFailure");
class IBCBridge extends BaseBridge_1.BaseBridge {
  ...
  loadChainConfigByChainId(chainId) {
    ...
    const chainConfig = Object.values(this.context.chainConfigsByNetwork).find(
      (c) => (c === null || c === void 0 ? void 0 : c.chainId) === chainId,
    );
    if (
      (chainConfig === null || chainConfig === void 0
        ? void 0
        : chainConfig.chainType) !== "ibc"
    ) {
  ...
  extractTransferMetadataFromTx(tx) {
    return __awaiter(this, void 0, void 0, function* () {
      const logs = (0, logs_1.parseRawLog)(tx.rawLog);
      const sequence = (0, logs_1.findAttribute)(
        logs,
        "send_packet",
        "packet_sequence",
      ).value;
      const dstChannel = (0, logs_1.findAttribute)(
        logs,
        "send_packet",
        "packet_dst_channel",
      ).value;
      const dstPort = (0, logs_1.findAttribute)(
        logs,
        "send_packet",
        "packet_dst_port",
      ).value;
      const packet = (0, logs_1.findAttribute)(
        logs,
        "send_packet",
        "packet_data",
      ).value;
      const timeoutTimestampNanoseconds = (0, logs_1.findAttribute)(
        logs,
        "send_packet",
  ...
  checkIfPacketReceivedByTx(txOrTxHash, destinationNetwork) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const client = yield stargate_1.StargateClient.connect(
        sourceChain.rpcUrl,
      );
      const tx =
      ...
      const didReceive = Promise.resolve()
        .then((e) =>
          __awaiter(this, void 0, void 0, function* () {
            ...
            const receipt = yield queryClient.ibc.channel.packetReceipt(
              receivingPort,
              receivingChannelId,
              +sequence,
            );
  ...
  loadQueryClientByNetwork(network) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const tendermintClient =
        yield tendermint_rpc_1.Tendermint34Client.connect(
          destChainConfig.rpcUrl,
        );
      const queryClient = queries_1.QueryClient.withExtensions(
        tendermintClient,
        queries_1.setupIbcExtension,
        queries_1.setupBankExtension,
        queries_1.setupAuthExtension,
      );
      return queryClient;
    });
  }
  resolveBridgeParamsForImport(params) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (
        params.toChain.network === entities_1.Network.SIFCHAIN &&
        params.fromChain.chainConfig.chainType === "ibc"
      ) {
        paramsCopy.assetAmount =
          yield this.tokenRegistry.loadCounterpartyAssetAmount(
            params.assetAmount,
          );
      }
      return paramsCopy;
  ...
  fetchTransferGasFee(fromChain) {
    return __awaiter(this, void 0, void 0, function* () {
      if (Date.now() - this.lastFetchedGasPricesAt > 5 * 60 * 1000) {
        try {
          this.gasPrices = yield (0, cross_fetch_1.fetch)(
      ...
      return (0,
      entities_1.AssetAmount)(fromChain.nativeAsset, this.gasPrices[fromChain.chainConfig.chainId] || native_1.NativeDexClient.feeTable.transfer.gas);
    });
  }
  bridgeTokens(
    provider,
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const receivingStargateCient = yield stargate_1.SigningStargateClient ===
        null || stargate_1.SigningStargateClient === void 0
        ? void 0
        : stargate_1.SigningStargateClient.connectWithSigner(
            ...
            receivingSigner,
            {
              ...
              aminoTypes: new native_1.NativeAminoTypes(),
              gasLimits: {
                send: 80000,
                transfer: 360000,
                delegate: 250000,
      ...
      const timeoutHeight = yield (0,
      getTransferTimeoutData_1.getTransferTimeoutData)(
      ...
      const isEthereumAsset =
        params.assetAmount.homeNetwork === entities_1.Network.ETHEREUM ||
      ...
      const sifConfig = this.loadChainConfigByNetwork(
        entities_1.Network.SIFCHAIN,
      );
      const client = yield native_1.NativeDexClient.connect(
        sifConfig.rpcUrl,
        sifConfig.restUrl,
        sifConfig.chainId,
      );
      ...
      for (let batch of batches) {
        try {
          const gasAssetAmount = yield this.fetchTransferGasFee(
            params.fromChain,
          );
          const txDraft = new native_1.NativeDexTransaction(
            params.fromAddress,
            batch,
            {
              price: {
                ...
                amount:
                  ((_a = fromChainConfig.keplrChainInfo.gasPriceStep) ===
                    null || _a === void 0
                    ? void 0
                    : _a.high.toString()) ||
                  native_1.NativeDexClient.feeTable.transfer.amount[0].amount,
              },
              gas:
            ...
            code:
              +(
                ((_e =
                  (_d =
                    (_c =
                      (_b = e === null || e === void 0 ? void 0 : e.message) ===
                        null || _b === void 0
                        ? void 0
                        : _b.split("code ")) === null || _c === void 0
                      ? void 0
  ...
  estimateFees(wallet, params) {
    if (params.toChain.network !== entities_1.Network.SIFCHAIN) {
      return (0, ibcExportFees_1.calculateIBCExportFee)(params.assetAmount);
    } else {
      return undefined;
    }
  }
  ...
  transfer(provider, params) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      for (let txResult of responses.reverse()) {
        if ((0, launchpad_1.isBroadcastTxFailure)(txResult)) {
          throw new Error((0, parseTxFailure_1.parseTxFailure)(txResult).memo);
        }
        const logs = (0, logs_1.parseRawLog)(txResult.rawLog);
        ...
        return Object.assign(Object.assign({ type: "ibc" }, params), {
  ...
  waitForTransferComplete(provider, tx, onUpdate) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const logs =
        (_b =
          (_a = ibcTx.meta) === null || _a === void 0 ? void 0 : _a.logs) ===
          null || _b === void 0
          ? void 0
          : _b.filter((item) =>
              item.events.some((ev) => ev.type === "ibc_transfer"),
      ...
      const timeoutHeight = (0, logs_1.findAttribute)(
        logs,
        "send_packet",
      ...
      const client = yield stargate_1.SigningStargateClient === null ||
      stargate_1.SigningStargateClient === void 0
        ? void 0
        : stargate_1.SigningStargateClient.connectWithSigner(
            config.rpcUrl,
            yield provider.getSendingSigner(tx.toChain),
          );
      while (true) {
        ...
        try {
          const received = yield this.checkIfPacketReceived(
            tx.toChain.network,
            dstChannel.value,
            dstPort.value,
            sequence.value,
