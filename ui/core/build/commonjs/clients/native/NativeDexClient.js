...
const TokenRegistryV1Query = __importStar(
  require("../../generated/proto/sifnode/tokenregistry/v1/query"),
);
const TokenRegistryV1Tx = __importStar(
  require("../../generated/proto/sifnode/tokenregistry/v1/tx"),
);
const CLPV1Query = __importStar(
  require("../../generated/proto/sifnode/clp/v1/querier"),
);
const CLPV1Tx = __importStar(
  require("../../generated/proto/sifnode/clp/v1/tx"),
);
const DispensationV1Query = __importStar(
  require("../../generated/proto/sifnode/dispensation/v1/query"),
);
const DispensationV1Tx = __importStar(
  require("../../generated/proto/sifnode/dispensation/v1/tx"),
);
const EthbridgeV1Query = __importStar(
  require("../../generated/proto/sifnode/ethbridge/v1/query"),
);
const EthbridgeV1Tx = __importStar(
  require("../../generated/proto/sifnode/ethbridge/v1/tx"),
);
const IBCTransferV1Tx = __importStar(
  require("@cosmjs/stargate/build/codec/ibc/applications/transfer/v1/tx"),
);
const CosmosBankV1Tx = __importStar(
  require("@cosmjs/stargate/build/codec/cosmos/bank/v1beta1/tx"),
);
const CosmosStakingV1Tx = __importStar(
  require("@cosmjs/stargate/build/codec/cosmos/staking/v1beta1/tx"),
);
const CosmosStakingV1Query = __importStar(
  require("@cosmjs/stargate/build/codec/cosmos/staking/v1beta1/query"),
);
const CosmosDistributionV1Tx = __importStar(
  require("@cosmjs/stargate/build/codec/cosmos/distribution/v1beta1/tx"),
);
const CosmosDistributionV1Query = __importStar(
  require("@cosmjs/stargate/build/codec/cosmos/distribution/v1beta1/query"),
);
const tendermint_rpc_1 = require("@cosmjs/tendermint-rpc");
const stargate_1 = require("@cosmjs/stargate");
const registry_1 = require("@cosmjs/proto-signing/build/registry");
...
class NativeDexClient {
  ...
  static parseTxResult(result) {
    try {
      if ((0, launchpad_1.isBroadcastTxFailure)(result)) {
        /* istanbul ignore next */ // TODO: fix coverage
        return (0, parseTxFailure_1.parseTxFailure)(result);
      }
      return {
      ...
      return (0, parseTxFailure_1.parseTxFailure)({
        transactionHash: "",
        rawLog: e === null || e === void 0 ? void 0 : e.message,
      });
    }
  }
  /**
  ...
  static createCustomTypesForModule(nativeModule) {
    ...
    for (const [prop, type] of Object.entries(nativeModule)) {
      if (!(0, proto_signing_1.isTsProtoGeneratedType)(type)) {
        continue;
      }
  ...
  createSigningClient(signer) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const client = yield stargate_2.SigningStargateClient.connectWithSigner(
        this.rpcUrl,
        signer,
        {
    ...
    const createTxClient = (txModule) => {
      ...
      const createTxCompositionMethod = (methodName) => {
        ...
        const compositionMethod = (
          ...
          return new NativeDexTransaction_1.NativeDexTransaction(
            senderAddress,
            [
              {
                typeUrl,
  ...
  static createQueryClient(t34) {
    return stargate_2.QueryClient.withExtensions(
      t34,
      stargate_2.setupIbcExtension,
      stargate_2.setupBankExtension,
      stargate_2.setupAuthExtension,
      (base) => {
        const rpcClient = (0, stargate_2.createProtobufRpcClient)(base);
        return {
...
NativeDexClient.feeTable = (0, stargate_1.buildFeeTable)(
  stargate_1.defaultGasPrice,
  {
    send: 80000,
    transfer: 250000,
    delegate: 250000,
