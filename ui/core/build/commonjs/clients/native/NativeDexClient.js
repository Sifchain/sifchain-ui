...
const CosmosStakingV1Tx = __importStar(require("@cosmjs/stargate/build/codec/cosmos/staking/v1beta1/tx"));
const CosmosStakingV1Query = __importStar(require("@cosmjs/stargate/build/codec/cosmos/staking/v1beta1/query"));
const CosmosDistributionV1Tx = __importStar(require("@cosmjs/stargate/build/codec/cosmos/distribution/v1beta1/tx"));
const CosmosDistributionV1Query = __importStar(require("@cosmjs/stargate/build/codec/cosmos/distribution/v1beta1/query"));
...
class NativeDexClient {
    ...
    static parseTxResult(result) {
        try {
            ...
            return (0, parseTxFailure_1.parseTxFailure)({ transactionHash: "", rawLog: e === null || e === void 0 ? void 0 : e.message });
        }
    }
    /**
     *
...
NativeDexClient.feeTable = (0, stargate_1.buildFeeTable)(stargate_1.defaultGasPrice, {
    send: 80000,
    transfer: 250000,
    delegate: 250000,
    undelegate: 250000,
