...
exports.SifClient =
  exports.Compatible42SigningCosmosClient =
  exports.Compatible42CosmosClient =
    void 0;
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      return result.code !== undefined
        ...
        : {
            ...
            transactionHash: result.txhash,
            data: result.data
              ? (0, encoding_1.fromHex)(result.data)
              : undefined,
          };
    });
  }
...
class SifClient extends Compatible42SigningCosmosClient {
  constructor(
    ...
    gasPrice,
    gasLimits,
    broadcastMode = launchpad_1.BroadcastMode.Block,
  ) {
    super(apiUrl, senderAddress, signer, gasPrice, gasLimits, broadcastMode);
    this.rpcUrl = rpcUrl;
    this.wallet = signer;
    this.unsignedClient = new SifUnsignedClient_1.SifUnSignedClient(
      apiUrl,
      wsUrl,
      rpcUrl,
      broadcastMode,
