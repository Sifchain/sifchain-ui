    ...
    __awaiter(void 0, void 0, void 0, function* () {
      if (!tokenRegistryPromise) {
        tokenRegistryPromise = (() =>
          __awaiter(void 0, void 0, void 0, function* () {
            var _a, _b;
            const dex = yield clients_1.NativeDexClient.connect(
              context.sifRpcUrl,
              context.sifApiUrl,
              context.sifChainId,
            );
  ...
  const self = {
    ...
    loadCounterpartyAsset(nativeAsset) {
      return __awaiter(this, void 0, void 0, function* () {
        ...
        return (0,
        __1.Asset)(Object.assign(Object.assign({}, nativeAsset), { symbol: counterpartyEntry.denom, decimals: +counterpartyEntry.decimals }));
      });
    },
    loadNativeAsset(counterpartyAsset) {
      return __awaiter(this, void 0, void 0, function* () {
        ...
        return (0,
        __1.Asset)(Object.assign(Object.assign({}, counterpartyAsset), { symbol: nativeEntry.denom, decimals: +nativeEntry.decimals }));
      });
    },
    loadCounterpartyAssetAmount: (nativeAssetAmount) =>
      __awaiter(void 0, void 0, void 0, function* () {
        ...
        const decimalAmount = (0, __1.fromBaseUnits)(
          nativeAssetAmount.amount.toString(),
          nativeAssetAmount.asset,
        );
        const convertedIntAmount = (0, __1.toBaseUnits)(
          decimalAmount,
          counterpartyAsset,
        );
    ...
    loadConnection(params) {
      return __awaiter(this, void 0, void 0, function* () {
        ...
        const sourceIsNative =
          params.fromChain.network === __1.Network.SIFCHAIN;
