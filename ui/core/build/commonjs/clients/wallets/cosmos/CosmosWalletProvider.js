    ...
    getIBCDenomTracesLookup(chain) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const denomTracesRestPromise = (() => __awaiter(this, void 0, void 0, function* () {
                try {
                    const denomTracesRes = yield (0, cross_fetch_1.default)(`${chainConfig.restUrl}/ibc/applications/transfer/v1beta1/denom_traces`);
            ...
            for (let denomTrace of denomTraces.denomTraces) {
                ...
                const hash = yield (0, createIBCHash_1.createIBCHash)(port, channelIds[0], denomTrace.baseDenom);
            ...
            for (let coin of balances) {
                ...
                if (!coin.denom.startsWith("ibc/")) {
                    ...
                    try {
                        ...
                        const assetAmount = yield this.tokenRegistry.loadNativeAssetAmount((0, entities_1.AssetAmount)(asset || coin.denom, coin.amount));
                    ...
                    try {
                        ...
                        const assetAmount = (0, entities_1.AssetAmount)(counterpartyAsset, coin.amount);
