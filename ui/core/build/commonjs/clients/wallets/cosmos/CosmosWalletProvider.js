...
class CosmosWalletProvider extends WalletProvider_1.WalletProvider {
  constructor(context) {
    ...
    this.tokenRegistry = (0, TokenRegistry_1.TokenRegistry)(context);
  }
  isChainSupported(chain) {
    return chain.chainConfig.chainType === "ibc";
  }
  parseTxResultToStatus(txResult) {
    return native_1.NativeDexClient.parseTxResult(txResult);
  }
  getRequiredApprovalAmount(chain, tx, amount) {
    return __awaiter(this, void 0, void 0, function* () {
      return (0, entities_1.AssetAmount)(amount.asset, "0");
    });
  }
  ...
  getStargateClient(chain) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      return stargate_1.SigningStargateClient === null ||
  ...
  getQueryClient(chain) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const tendermintClient =
        yield tendermint_rpc_1.Tendermint34Client.connect(chainConfig.rpcUrl);
      return stargate_1.QueryClient.withExtensions(
        tendermintClient,
        stargate_1.setupIbcExtension,
  ...
  getIBCDenomTracesLookup(chain) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const denomTracesRestPromise = (() =>
        __awaiter(this, void 0, void 0, function* () {
          try {
            const denomTracesRes = yield (0, cross_fetch_1.default)(
      ...
      if (
        !(denomTraces === null || denomTraces === void 0
          ? void 0
      ...
      for (let denomTrace of denomTraces.denomTraces) {
        ...
        const hash = yield (0, createIBCHash_1.createIBCHash)(
          port,
          channelIds[0],
      ...
      if (chain.network === entities_1.Network.SIFCHAIN) {
        ...
        try {
          const ibcEntries = (yield this.tokenRegistry.load()).filter(
  ...
  fetchBalances(chain, address) {
    return __awaiter(this, void 0, void 0, function* () {
      const queryClient = yield this.getQueryClient(chain);
      const balances = yield queryClient === null || queryClient === void 0
        ? void 0
      ...
      for (let coin of balances) {
        ...
        if (!coin.denom.startsWith("ibc/")) {
          ...
          try {
            ...
            const assetAmount = yield this.tokenRegistry.loadNativeAssetAmount(
              (0, entities_1.AssetAmount)(asset || coin.denom, coin.amount),
            );
          ...
          try {
            ...
            const counterpartyAsset =
              yield this.tokenRegistry.loadCounterpartyAsset(nativeAsset);
            const assetAmount = (0, entities_1.AssetAmount)(
              counterpartyAsset,
              coin.amount,
            );
            assetAmounts.push(
              yield this.tokenRegistry.loadNativeAssetAmount(assetAmount),
            );
          } catch (error) {
