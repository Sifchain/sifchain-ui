...
class DirectSecp256k1HdWalletProvider extends CosmosWalletProvider_1.CosmosWalletProvider {
  ...
  getSendingSigner(chain) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const wallet = yield proto_signing_1.DirectSecp256k1HdWallet.fromMnemonic(
        this.options.mnemonic || "",
        {
          hdPaths: [(0, crypto_1.stringToPath)(parts.join("/"))],
  ...
  sign(chain, tx) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const stargate = yield stargate_1.SigningStargateClient.connectWithSigner(
        chainConfig.rpcUrl,
        signer,
      );
      const signed = yield stargate.sign(
        tx.fromAddress,
        tx.msgs,
        {
          amount: [tx.fee.price],
      ...
      return new native_1.NativeDexSignedTransaction(tx, signed);
    });
  }
  broadcast(chain, tx) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const result = yield stargate.broadcastTx(
        Uint8Array.from(tx_1.TxRaw.encode(signed).finish()),
      );
      return result;
    });
  }
