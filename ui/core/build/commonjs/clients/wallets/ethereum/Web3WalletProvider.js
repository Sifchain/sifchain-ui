...
const RateLimitProtector_1 = __importDefault(require("../../../utils/RateLimitProtector"));
...
class Web3WalletProvider extends WalletProvider_1.WalletProvider {
    constructor(context, options) {
        ...
        this.fetchBalance = new RateLimitProtector_1.default({
            padding: 100,
    ...
    onProviderEvent(eventName, callback) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return () => {
                var _a;
                return (_a = web3.currentProvider) === null || _a === void 0 ? void 0 : _a.off(eventName, callback);
            };
        });
    }
    ...
    getRequiredApprovalAmount(chain, tx, assetAmount) {
        return __awaiter(this, void 0, void 0, function* () {
            if (assetAmount.symbol.toLowerCase() === "eth") {
                return (0, entities_1.AssetAmount)(assetAmount.asset, "0");
            }
            ...
            const hasAlreadyApprovedSpend = yield tokenContract.methods
                ...
                .call();
            if (jsbi_1.default.lessThan(jsbi_1.default.BigInt(hasAlreadyApprovedSpend), assetAmount.toBigInt())) {
                return assetAmount;
            }
            return (0, entities_1.AssetAmount)(assetAmount.asset, "0");
        });
    ...
    approve(chain, tx, amount) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const requiredAmount = yield this.getRequiredApprovalAmount(chain, tx, amount);
            if (requiredAmount === null || requiredAmount === void 0 ? void 0 : requiredAmount.greaterThan("0")) {
                const sendArgs = {
                    from: tx.fromAddress,
                    value: 0,
                    gas: 150000,
    ...
    fetchBalance(chain, address, symbol) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (asset.symbol === chain.nativeAsset.symbol) {
                return (0, entities_1.AssetAmount)(asset, yield web3.eth.getBalance(address));
            }
            if (!asset.address) {
                return (0, entities_1.AssetAmount)(asset, "0");
            }
            ...
            return (0, entities_1.AssetAmount)(asset, amount);
        });
    }
    fetchBalances(chain, address) {
        return __awaiter(this, void 0, void 0, function* () {
            console.log("running");
            return Promise.all(chain.assets.map((asset) => __awaiter(this, void 0, void 0, function* () { return this.fetchBalance(chain, address, asset.symbol); })));
        });
    }
}
