...
exports.Web3WalletProvider =
  exports.isEventEmittingProvider =
  exports.Web3Transaction =
    void 0;
...
const RateLimitProtector_1 = __importDefault(
  require("../../../utils/RateLimitProtector"),
);
  ...
  getRequiredApprovalAmount(chain, tx, assetAmount) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const hasAlreadyApprovedSpend = yield tokenContract.methods
        ...
        .call();
      if (
        jsbi_1.default.lessThan(
          jsbi_1.default.BigInt(hasAlreadyApprovedSpend),
  ...
  fetchBalance(chain, address, symbol) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (asset.symbol === chain.nativeAsset.symbol) {
        return (0, entities_1.AssetAmount)(
          asset,
          yield web3.eth.getBalance(address),
        );
      }
      if (!asset.address) {
