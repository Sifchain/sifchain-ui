...
class IxoChain extends _BaseChain_1.BaseChain {
    getBlockExplorerUrlForTxHash(hash) {
        return (0, url_join_ts_1.urlJoin)(this.chainConfig.blockExplorerUrl, "/cosmos/tx/v1beta1/txs/", hash);
    }
    getBlockExplorerUrlForAddress(address) {
        return (0, url_join_ts_1.urlJoin)(this.chainConfig.blockExplorerUrl, "/cosmos/bank/v1beta1/balances/", address);
    }
}
