...
class BaseChain {
    ...
    findAssetWithLikeSymbol(symbol) {
        return this.assets.find((asset) => (0, isLikeSymbol_1.isLikeSymbol)(asset.symbol, symbol));
    }
    findAssetWithLikeSymbolOrThrow(symbol) {
        const asset = this.assets.find((asset) => (0, isLikeSymbol_1.isLikeSymbol)(asset.symbol, symbol));
        if (!asset)
