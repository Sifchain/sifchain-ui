...
const proposals: Proposal[] = [
  ...
  },
  {
    ...
    endDateTime: new Date(1644004800000),
    heading: `Sif's Expansion Bonus (v4)`,
    title: `Bonus Coin Vote`,
    description: `Polls are now open for the Pools of the People v4 - Bonus Coin Vote. The voting period will end on 2/4 at 12pm PST. Please select 4 bonus coin pools, in order of preference.`,
    voteType: "pools",
    maxBallots: 4,
