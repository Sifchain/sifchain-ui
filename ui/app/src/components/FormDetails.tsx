...
export const FormDetails = defineComponent({
  props: {
    details: {
        ...
        {props.details.map(([key, value], index, arr) => (
          <div
            class={[
              ...
              border-l-[1px] border-b-[1px] border-r-[1px] border-solid`,
              index == 0 && `rounded-t border-t-[1px]`,
              index == arr.length - 1 && `rounded-b border-b-[1px]`,
            ]}
          >
            <div class="pl-[20px] text-left w-full text-[16px] text-white font-sans font-medium">
              {key}
            </div>
            <div
              class={[
                `flex flex-row justify-end mr-[14px] items-center pl-[20px] text-right w-full text-[16px] text-white font-mono font-medium`,
              ]}
            >
              {value}
