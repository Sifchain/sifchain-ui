...
export const _CallToAction = (
  ...
  return (
    <button
      {...props}
      class={[
        `w-full uppercase font-extrabold h-[62px] bg-accent-dark dgradient-image-background dbg-accent-gradient rounded-[8px] bdg-accent-gradient flex items-center justify-center font-sans text-[18px] text-white disabled:bdg-none disabled:cursor-not-allowed`,
        props.class,
      ]}
      style={
        mergeProps(
